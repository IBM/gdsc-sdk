...
To learn how to use the SDK, check out our [Examples](https://github.com/IBM/gdsc-sdk/tree/release-v1.0.0/sdk-example/typescript/src).
...
The full API of this library can be found in [sdk.md file](https://github.com/IBM/gdsc-sdk/blob/release-v1.0.0/typescript/sdk.md) along with many code [examples](https://github.com/IBM/gdsc-sdk/tree/release-v1.0.0/sdk-example/typescript/src). The code below shows how to get started using the JumboxServiceGetUsers.
