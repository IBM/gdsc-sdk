...
export class Policybuilderv3GetPolicyVersionsInfoResponse {
    'status'?: Policybuilderv3StatusResponseBase;
    'versionsInfo'?: Array<Policybuilderv3VersionInfo>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "versionsInfo",
            "baseName": "versions_info",
            "type": "Array<Policybuilderv3VersionInfo>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return Policybuilderv3GetPolicyVersionsInfoResponse.attributeTypeMap;
    }
