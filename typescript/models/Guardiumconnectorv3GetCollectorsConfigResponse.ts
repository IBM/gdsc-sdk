...
*/
export class Guardiumconnectorv3GetCollectorsConfigResponse {
    /**
    * list of collectors.
    */
    'collectorsConfig'?: Array<Guardiumconnectorv3CollectorConfig>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "baseName": "collectors_config",
            "type": "Array<Guardiumconnectorv3CollectorConfig>",
            "format": ""
        },
        {
            "name": "status",
    ...
    static getAttributeTypeMap() {
        return Guardiumconnectorv3GetCollectorsConfigResponse.attributeTypeMap;
    }
