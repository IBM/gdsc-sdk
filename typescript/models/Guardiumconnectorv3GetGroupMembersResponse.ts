...
*/
export class Guardiumconnectorv3GetGroupMembersResponse {
    /**
    * List of group memebers fetched with the command.
    */
    'groups'?: Array<Guardiumconnectorv3Group>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "groups",
            "baseName": "groups",
            "type": "Array<Guardiumconnectorv3Group>",
            "format": ""
        },
        {
            "name": "status",
    ...
    static getAttributeTypeMap() {
        return Guardiumconnectorv3GetGroupMembersResponse.attributeTypeMap;
    }
