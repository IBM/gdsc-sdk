...
export class Policybuilderv3GetPolicySyncListResponse {
    'policies'?: Array<Policybuilderv3GdpPolicySyncRes>;
    ...
    static getAttributeTypeMap() {
        return Policybuilderv3GetPolicySyncListResponse.attributeTypeMap;
    }
