...
export class Policybuilderv3GetGdpPolicyMetaDataResponse {
    'policies'?: Array<Policybuilderv3GdpPolicyObjectWithCm>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "policies",
            "baseName": "policies",
            "type": "Array<Policybuilderv3GdpPolicyObjectWithCm>",
            "format": ""
        },
        {
            "name": "status",
    ...
    static getAttributeTypeMap() {
        return Policybuilderv3GetGdpPolicyMetaDataResponse.attributeTypeMap;
    }
