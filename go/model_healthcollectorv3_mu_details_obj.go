...
type Healthcollectorv3MuDetailsObj struct {
	// Aggregation details.
	AggregationDetailsList []Healthcollectorv3AggregationDetailsObject `json:"aggregation_details_list,omitempty"`
	...
	UtilizationParametersValues *Healthcollectorv3UtilizationParameterObject `json:"utilization_parameters_values,omitempty"`
}
