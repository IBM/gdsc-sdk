...
type LinkedAccounts struct {
	...
	IsMainCloudAccount bool `json:"isMainCloudAccount"`
	InstallationStatus *InstallationStatus `json:"installationStatus"`
	ServiceProvider *ServiceProvider `json:"serviceProvider"`
	RegionAvailability *map[string]bool `json:"regionAvailability,omitempty"`
	Regions []AnalyzedRegion `json:"regions"`
