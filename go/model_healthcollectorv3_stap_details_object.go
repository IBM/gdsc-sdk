...
type Healthcollectorv3StapDetailsObject struct {
	...
	StapLivelinessInformation *Healthcollectorv3StapLiveInfoObject `json:"stap_liveliness_information,omitempty"`
