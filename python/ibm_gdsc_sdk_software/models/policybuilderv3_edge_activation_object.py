...
class Policybuilderv3EdgeActivationObject(BaseModel):
    ...
    """ # noqa: E501
    activatation_timestamp: Optional[datetime] = None
    ...
    __properties: ClassVar[List[str]] = ["activatation_timestamp", "activation_order", "activation_status", "edge_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activatation_timestamp": obj.get("activatation_timestamp"),
