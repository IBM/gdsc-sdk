...
class Qspmdatamanagerv3InsertEntitiesRequest(BaseModel):
    """
    InsertEntitiesRequest is the request object for InsertAllEntities API.
    """ # noqa: E501
    dims: Optional[List[Dict[str, Any]]] = None
    facts: Optional[List[Dict[str, Any]]] = None
    policysqls: Optional[List[StrictStr]] = None
    scan_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["dims", "facts", "policysqls", "scan_id"]
