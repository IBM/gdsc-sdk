...
host=${URL}
json='{"users":[{"distinguished_name":"uid=3J3788897,c=us,ou=bluepages,o=ibm.com","roles":["admin","default"]}]}'

echo ${json} | ./client.sh  --host ${host} -u ${user}:${password} jumpboxServicePostUsers -
