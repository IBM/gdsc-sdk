import { AuthMethodsConfiguration, ServerConfiguration, Middleware, RequestContext, ResponseContext, createConfiguration, JumpboxServiceApi, Jumpboxv3PostTenantsRequest} from '@guardium/ibm-gdsc-sdk-software';
...
const request:Jumpboxv3PostTenantsRequest = {
    name: 'GuardiumSDK', 
    uid: 'minhui_yang@us.ibm.com',
}

const postTenants = async (request:Jumpboxv3PostTenantsRequest) => {
    const response = await apiInstance.jumpboxServicePostTenants(request);
