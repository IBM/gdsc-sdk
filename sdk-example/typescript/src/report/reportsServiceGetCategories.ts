...
const getReportCategories = async (reportId: string) => {
    const response = await apiInstance.reportsServiceGetCategories(reportId);
    console.log('API called successfully. Returned data: ' + JSON.stringify(response));
  
}

const reportId = '000000000000000000002001';
