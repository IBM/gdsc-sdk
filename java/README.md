...
```groovy
  ...
  dependencies {
     implementation "com.ibm.security.guardium:com.ibm.security.guardium.saas:3.0.20250227"
  }
```
...
* `target/com.ibm.security.guardium.saas-3.0.20250227.jar`
* `target/lib/*.jar`
