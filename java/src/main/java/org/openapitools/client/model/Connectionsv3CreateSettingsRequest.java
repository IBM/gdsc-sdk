...
import org.openapitools.client.model.Connectionsv3ConnectorSetting;
...
public class Connectionsv3CreateSettingsRequest {
  ...
  public Connectionsv3CreateSettingsRequest addSettingsItem(Connectionsv3ConnectorSetting settingsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Connectionsv3CreateSettingsRequest connectionsv3CreateSettingsRequest = (Connectionsv3CreateSettingsRequest) o;
    return Objects.equals(this.settings, connectionsv3CreateSettingsRequest.settings);
  }
  ...
  public String toString() {
    ...
    sb.append("class Connectionsv3CreateSettingsRequest {\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Connectionsv3CreateSettingsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Connectionsv3CreateSettingsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Connectionsv3CreateSettingsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Connectionsv3CreateSettingsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<Connectionsv3CreateSettingsRequest>() {
           @Override
           public void write(JsonWriter out, Connectionsv3CreateSettingsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Connectionsv3CreateSettingsRequest read(JsonReader in) throws IOException {
