...
public class Guardiumconnectorv3GeneralDetailsObject {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Guardiumconnectorv3GeneralDetailsObject guardiumconnectorv3GeneralDetailsObject = (Guardiumconnectorv3GeneralDetailsObject) o;
    return Objects.equals(this.errMessages, guardiumconnectorv3GeneralDetailsObject.errMessages);
  }
  ...
  public String toString() {
    ...
    sb.append("class Guardiumconnectorv3GeneralDetailsObject {\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Guardiumconnectorv3GeneralDetailsObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Guardiumconnectorv3GeneralDetailsObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Guardiumconnectorv3GeneralDetailsObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Guardiumconnectorv3GeneralDetailsObject.class));

       return (TypeAdapter<T>) new TypeAdapter<Guardiumconnectorv3GeneralDetailsObject>() {
           @Override
           public void write(JsonWriter out, Guardiumconnectorv3GeneralDetailsObject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Guardiumconnectorv3GeneralDetailsObject read(JsonReader in) throws IOException {
