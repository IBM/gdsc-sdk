...
public class Reportsv3JoinDefinition {
  ...
  public Reportsv3JoinDefinition categoryId(String categoryId) {
  ...
  **/
  ...
  public Reportsv3JoinDefinition headerPairList(List<Reportsv3HeaderPair> headerPairList) {
  ...
  **/
  ...
  public Reportsv3JoinDefinition sourceTableName(String sourceTableName) {
  ...
  **/
  ...
  public Reportsv3JoinDefinition targetHeadersSelectedIds(List<String> targetHeadersSelectedIds) {
  ...
  **/
  ...
  public Reportsv3JoinDefinition targetTableName(String targetTableName) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Reportsv3JoinDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Reportsv3JoinDefinition is not found in the empty JSON string", Reportsv3JoinDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Reportsv3JoinDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Reportsv3JoinDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
