...
import org.openapitools.client.model.Complianceacceleratorv3GroupMember;
...
public class Complianceacceleratorv3Group {
  ...
  private List<Complianceacceleratorv3GroupMember> members = new ArrayList<>();
  ...
  private List<Complianceacceleratorv3GroupMember> membersToDelete = new ArrayList<>();
  ...
  **/
  ...
  public Complianceacceleratorv3Group members(List<Complianceacceleratorv3GroupMember> members) {
    this.members = members;
    return this;
  }

  public Complianceacceleratorv3Group addMembersItem(Complianceacceleratorv3GroupMember membersItem) {
  ...
  **/
  @javax.annotation.Nullable
  public List<Complianceacceleratorv3GroupMember> getMembers() {
    return members;
  }

  public void setMembers(List<Complianceacceleratorv3GroupMember> members) {
    this.members = members;
  }
  ...
  **/
  ...
  public Complianceacceleratorv3Group membersToDelete(List<Complianceacceleratorv3GroupMember> membersToDelete) {
    this.membersToDelete = membersToDelete;
    return this;
  }

  public Complianceacceleratorv3Group addMembersToDeleteItem(Complianceacceleratorv3GroupMember membersToDeleteItem) {
  ...
  **/
  @javax.annotation.Nullable
  public List<Complianceacceleratorv3GroupMember> getMembersToDelete() {
    return membersToDelete;
  }

  public void setMembersToDelete(List<Complianceacceleratorv3GroupMember> membersToDelete) {
    this.membersToDelete = membersToDelete;
  }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(desc, groupTypeId, id, members, membersToAdd, membersToDelete, name, parent);
  }
      ...
      if (jsonObj.get("members") != null && !jsonObj.get("members").isJsonNull()) {
        ...
        if (jsonArraymembers != null) {
          ...
          for (int i = 0; i < jsonArraymembers.size(); i++) {
            Complianceacceleratorv3GroupMember.validateJsonElement(jsonArraymembers.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("members_to_delete") != null && !jsonObj.get("members_to_delete").isJsonNull()) {
        ...
        if (jsonArraymembersToDelete != null) {
          ...
          for (int i = 0; i < jsonArraymembersToDelete.size(); i++) {
            Complianceacceleratorv3GroupMember.validateJsonElement(jsonArraymembersToDelete.get(i));
          };
        }
      }
