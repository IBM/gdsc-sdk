...
public class AuthserverListOauthClientResponse {
  ...
  public AuthserverListOauthClientResponse addOauthClientsItem(AuthserverOauthClient oauthClientsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AuthserverListOauthClientResponse authserverListOauthClientResponse = (AuthserverListOauthClientResponse) o;
    return Objects.equals(this.oauthClients, authserverListOauthClientResponse.oauthClients);
  }

  @Override
  public int hashCode() {
    return Objects.hash(oauthClients);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AuthserverListOauthClientResponse {\n");
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("oauth_clients") != null && !jsonObj.get("oauth_clients").isJsonNull()) {
        JsonArray jsonArrayoauthClients = jsonObj.getAsJsonArray("oauth_clients");
        if (jsonArrayoauthClients != null) {
          ...
          for (int i = 0; i < jsonArrayoauthClients.size(); i++) {
            AuthserverOauthClient.validateJsonElement(jsonArrayoauthClients.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthserverListOauthClientResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthserverListOauthClientResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthserverListOauthClientResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthserverListOauthClientResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthserverListOauthClientResponse>() {
           @Override
           public void write(JsonWriter out, AuthserverListOauthClientResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuthserverListOauthClientResponse read(JsonReader in) throws IOException {
