...
import org.openapitools.client.model.Tenantuserv3UserState;
...
public class Tenantuserv3User {
  ...
  **/
  ...
  public Tenantuserv3User putMetadataItem(String key, String metadataItem) {
  ...
  **/
  ...
  public Tenantuserv3User addRolesItem(String rolesItem) {
    if (this.roles == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Tenantuserv3User tenantuserv3User = (Tenantuserv3User) o;
    return Objects.equals(this.activationDate, tenantuserv3User.activationDate) &&
        Objects.equals(this.directoryId, tenantuserv3User.directoryId) &&
        Objects.equals(this.disabled, tenantuserv3User.disabled) &&
        Objects.equals(this.displayName, tenantuserv3User.displayName) &&
        Objects.equals(this.distinguishedName, tenantuserv3User.distinguishedName) &&
        Objects.equals(this.email, tenantuserv3User.email) &&
        Objects.equals(this.externalId, tenantuserv3User.externalId) &&
        Objects.equals(this.metadata, tenantuserv3User.metadata) &&
        Objects.equals(this.roles, tenantuserv3User.roles) &&
        Objects.equals(this.state, tenantuserv3User.state) &&
        Objects.equals(this.uid, tenantuserv3User.uid) &&
        Objects.equals(this.userId, tenantuserv3User.userId);
  }
  ...
  public String toString() {
    ...
    sb.append("class Tenantuserv3User {\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Tenantuserv3User.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Tenantuserv3User' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Tenantuserv3User> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Tenantuserv3User.class));

       return (TypeAdapter<T>) new TypeAdapter<Tenantuserv3User>() {
           @Override
           public void write(JsonWriter out, Tenantuserv3User value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Tenantuserv3User read(JsonReader in) throws IOException {
