...
public class Guardiumconnectorv3MUDetailsObj {
  ...
  public Guardiumconnectorv3MUDetailsObj addAggHealthViewListItem(Guardiumconnectorv3AggregationViewListObject aggHealthViewListItem) {
  ...
  **/
  ...
  public Guardiumconnectorv3MUDetailsObj addGeneralErrMessagesItem(String generalErrMessagesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Guardiumconnectorv3MUDetailsObj guardiumconnectorv3MUDetailsObj = (Guardiumconnectorv3MUDetailsObj) o;
    return Objects.equals(this.aggHealthViewList, guardiumconnectorv3MUDetailsObj.aggHealthViewList) &&
        Objects.equals(this.connectivityDetails, guardiumconnectorv3MUDetailsObj.connectivityDetails) &&
        Objects.equals(this.generalErrMessages, guardiumconnectorv3MUDetailsObj.generalErrMessages) &&
        Objects.equals(this.utilizationScheme, guardiumconnectorv3MUDetailsObj.utilizationScheme);
  }
  ...
  public String toString() {
    ...
    sb.append("class Guardiumconnectorv3MUDetailsObj {\n");
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("agg_health_view_list") != null && !jsonObj.get("agg_health_view_list").isJsonNull()) {
        ...
        if (jsonArrayaggHealthViewList != null) {
          ...
          for (int i = 0; i < jsonArrayaggHealthViewList.size(); i++) {
            Guardiumconnectorv3AggregationViewListObject.validateJsonElement(jsonArrayaggHealthViewList.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("utilization_scheme") != null && !jsonObj.get("utilization_scheme").isJsonNull()) {
        Guardiumconnectorv3UtilizationParameterObject.validateJsonElement(jsonObj.get("utilization_scheme"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Guardiumconnectorv3MUDetailsObj.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Guardiumconnectorv3MUDetailsObj' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Guardiumconnectorv3MUDetailsObj> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Guardiumconnectorv3MUDetailsObj.class));

       return (TypeAdapter<T>) new TypeAdapter<Guardiumconnectorv3MUDetailsObj>() {
           @Override
           public void write(JsonWriter out, Guardiumconnectorv3MUDetailsObj value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Guardiumconnectorv3MUDetailsObj read(JsonReader in) throws IOException {
