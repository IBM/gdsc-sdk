...
public class Guardiumconnectorv3UpdateStreamingRequest {
  ...
  **/
  ...
  public Guardiumconnectorv3UpdateStreamingRequest addRecordsItem(Guardiumconnectorv3StatusRecord recordsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Guardiumconnectorv3UpdateStreamingRequest guardiumconnectorv3UpdateStreamingRequest = (Guardiumconnectorv3UpdateStreamingRequest) o;
    return Objects.equals(this.centralManagerId, guardiumconnectorv3UpdateStreamingRequest.centralManagerId) &&
        Objects.equals(this.records, guardiumconnectorv3UpdateStreamingRequest.records) &&
        Objects.equals(this.status, guardiumconnectorv3UpdateStreamingRequest.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(centralManagerId, records, status);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Guardiumconnectorv3UpdateStreamingRequest {\n");
  ...
  */
      ...
      if (jsonObj.get("records") != null && !jsonObj.get("records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            Guardiumconnectorv3StatusRecord.validateJsonElement(jsonArrayrecords.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Guardiumconnectorv3UpdateStreamingRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Guardiumconnectorv3UpdateStreamingRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Guardiumconnectorv3UpdateStreamingRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Guardiumconnectorv3UpdateStreamingRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<Guardiumconnectorv3UpdateStreamingRequest>() {
           @Override
           public void write(JsonWriter out, Guardiumconnectorv3UpdateStreamingRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Guardiumconnectorv3UpdateStreamingRequest read(JsonReader in) throws IOException {
