...
public class Guardiumconnectorv3BlockWhat {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Guardiumconnectorv3BlockWhat guardiumconnectorv3BlockWhat = (Guardiumconnectorv3BlockWhat) o;
    return Objects.equals(this.bdbname, guardiumconnectorv3BlockWhat.bdbname) &&
        Objects.equals(this.bip, guardiumconnectorv3BlockWhat.bip) &&
        Objects.equals(this.bport, guardiumconnectorv3BlockWhat.bport) &&
        Objects.equals(this.buser, guardiumconnectorv3BlockWhat.buser);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bdbname, bip, bport, buser);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Guardiumconnectorv3BlockWhat {\n");
    sb.append("    bdbname: ").append(toIndentedString(bdbname)).append("\n");
    sb.append("    bip: ").append(toIndentedString(bip)).append("\n");
    sb.append("    bport: ").append(toIndentedString(bport)).append("\n");
    sb.append("    buser: ").append(toIndentedString(buser)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Guardiumconnectorv3BlockWhat.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Guardiumconnectorv3BlockWhat' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Guardiumconnectorv3BlockWhat> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Guardiumconnectorv3BlockWhat.class));

       return (TypeAdapter<T>) new TypeAdapter<Guardiumconnectorv3BlockWhat>() {
           @Override
           public void write(JsonWriter out, Guardiumconnectorv3BlockWhat value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Guardiumconnectorv3BlockWhat read(JsonReader in) throws IOException {
