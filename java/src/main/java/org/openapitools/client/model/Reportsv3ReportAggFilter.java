...
import org.openapitools.client.model.Reportsv3ReportAggFilterCondition;
...
public class Reportsv3ReportAggFilter {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Reportsv3ReportAggFilter reportsv3ReportAggFilter = (Reportsv3ReportAggFilter) o;
    return Objects.equals(this.condition, reportsv3ReportAggFilter.condition);
  }
  ...
  public String toString() {
    ...
    sb.append("class Reportsv3ReportAggFilter {\n");
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("condition") != null && !jsonObj.get("condition").isJsonNull()) {
        Reportsv3ReportAggFilterCondition.validateJsonElement(jsonObj.get("condition"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Reportsv3ReportAggFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Reportsv3ReportAggFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Reportsv3ReportAggFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Reportsv3ReportAggFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<Reportsv3ReportAggFilter>() {
           @Override
           public void write(JsonWriter out, Reportsv3ReportAggFilter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Reportsv3ReportAggFilter read(JsonReader in) throws IOException {
