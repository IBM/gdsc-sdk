...
import org.openapitools.client.model.Riskanalyticscontrollerv3Action;
...
public class Riskanalyticscontrollerv3EnableDisableRiskEventProcessRequest {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Riskanalyticscontrollerv3EnableDisableRiskEventProcessRequest riskanalyticscontrollerv3EnableDisableRiskEventProcessRequest = (Riskanalyticscontrollerv3EnableDisableRiskEventProcessRequest) o;
    return Objects.equals(this.action, riskanalyticscontrollerv3EnableDisableRiskEventProcessRequest.action);
  }
  ...
  public String toString() {
    ...
    sb.append("class Riskanalyticscontrollerv3EnableDisableRiskEventProcessRequest {\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Riskanalyticscontrollerv3EnableDisableRiskEventProcessRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Riskanalyticscontrollerv3EnableDisableRiskEventProcessRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Riskanalyticscontrollerv3EnableDisableRiskEventProcessRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Riskanalyticscontrollerv3EnableDisableRiskEventProcessRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<Riskanalyticscontrollerv3EnableDisableRiskEventProcessRequest>() {
           @Override
           public void write(JsonWriter out, Riskanalyticscontrollerv3EnableDisableRiskEventProcessRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Riskanalyticscontrollerv3EnableDisableRiskEventProcessRequest read(JsonReader in) throws IOException {
