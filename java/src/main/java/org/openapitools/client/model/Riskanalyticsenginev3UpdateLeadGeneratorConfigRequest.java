...
import org.openapitools.client.model.Riskanalyticsenginev3LeadGeneratorConfig;
...
public class Riskanalyticsenginev3UpdateLeadGeneratorConfigRequest {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Riskanalyticsenginev3UpdateLeadGeneratorConfigRequest riskanalyticsenginev3UpdateLeadGeneratorConfigRequest = (Riskanalyticsenginev3UpdateLeadGeneratorConfigRequest) o;
    return Objects.equals(this.config, riskanalyticsenginev3UpdateLeadGeneratorConfigRequest.config);
  }
  ...
  public String toString() {
    ...
    sb.append("class Riskanalyticsenginev3UpdateLeadGeneratorConfigRequest {\n");
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("config") != null && !jsonObj.get("config").isJsonNull()) {
        Riskanalyticsenginev3LeadGeneratorConfig.validateJsonElement(jsonObj.get("config"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Riskanalyticsenginev3UpdateLeadGeneratorConfigRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Riskanalyticsenginev3UpdateLeadGeneratorConfigRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Riskanalyticsenginev3UpdateLeadGeneratorConfigRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Riskanalyticsenginev3UpdateLeadGeneratorConfigRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<Riskanalyticsenginev3UpdateLeadGeneratorConfigRequest>() {
           @Override
           public void write(JsonWriter out, Riskanalyticsenginev3UpdateLeadGeneratorConfigRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Riskanalyticsenginev3UpdateLeadGeneratorConfigRequest read(JsonReader in) throws IOException {
