...
public class ServiceAccountClientId {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServiceAccountClientId serviceAccountClientId = (ServiceAccountClientId) o;
    return Objects.equals(this.serviceAccountClientId, serviceAccountClientId.serviceAccountClientId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(serviceAccountClientId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ServiceAccountClientId {\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServiceAccountClientId.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServiceAccountClientId' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServiceAccountClientId> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServiceAccountClientId.class));

       return (TypeAdapter<T>) new TypeAdapter<ServiceAccountClientId>() {
           @Override
           public void write(JsonWriter out, ServiceAccountClientId value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServiceAccountClientId read(JsonReader in) throws IOException {
