...
public class Connectionsv3UpdateConnectionsAccountsRequest {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Connectionsv3UpdateConnectionsAccountsRequest connectionsv3UpdateConnectionsAccountsRequest = (Connectionsv3UpdateConnectionsAccountsRequest) o;
    return Objects.equals(this.account, connectionsv3UpdateConnectionsAccountsRequest.account) &&
        Objects.equals(this.accountId, connectionsv3UpdateConnectionsAccountsRequest.accountId);
  }
  ...
  public String toString() {
    ...
    sb.append("class Connectionsv3UpdateConnectionsAccountsRequest {\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Connectionsv3UpdateConnectionsAccountsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Connectionsv3UpdateConnectionsAccountsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Connectionsv3UpdateConnectionsAccountsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Connectionsv3UpdateConnectionsAccountsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<Connectionsv3UpdateConnectionsAccountsRequest>() {
           @Override
           public void write(JsonWriter out, Connectionsv3UpdateConnectionsAccountsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Connectionsv3UpdateConnectionsAccountsRequest read(JsonReader in) throws IOException {
