...
import org.openapitools.client.model.Workflowv3TaskCreate;
...
public class Workflowv3CreateTaskRequest {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Workflowv3CreateTaskRequest workflowv3CreateTaskRequest = (Workflowv3CreateTaskRequest) o;
    return Objects.equals(this.caseId, workflowv3CreateTaskRequest.caseId) &&
        Objects.equals(this.task, workflowv3CreateTaskRequest.task);
  }

  @Override
  public int hashCode() {
    return Objects.hash(caseId, task);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Workflowv3CreateTaskRequest {\n");
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("task") != null && !jsonObj.get("task").isJsonNull()) {
        Workflowv3TaskCreate.validateJsonElement(jsonObj.get("task"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Workflowv3CreateTaskRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Workflowv3CreateTaskRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Workflowv3CreateTaskRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Workflowv3CreateTaskRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<Workflowv3CreateTaskRequest>() {
           @Override
           public void write(JsonWriter out, Workflowv3CreateTaskRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Workflowv3CreateTaskRequest read(JsonReader in) throws IOException {
