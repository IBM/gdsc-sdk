...
public class Workflowv3GetTasksCountResponse {
  ...
  public Workflowv3GetTasksCountResponse addCountsItem(Workflowv3TaskCount countsItem) {
    if (this.counts == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Workflowv3GetTasksCountResponse workflowv3GetTasksCountResponse = (Workflowv3GetTasksCountResponse) o;
    return Objects.equals(this.counts, workflowv3GetTasksCountResponse.counts);
  }
  ...
  public String toString() {
    ...
    sb.append("class Workflowv3GetTasksCountResponse {\n");
  ...
  */
      ...
      if (jsonObj.get("counts") != null && !jsonObj.get("counts").isJsonNull()) {
        ...
        if (jsonArraycounts != null) {
          ...
          for (int i = 0; i < jsonArraycounts.size(); i++) {
            Workflowv3TaskCount.validateJsonElement(jsonArraycounts.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Workflowv3GetTasksCountResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Workflowv3GetTasksCountResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Workflowv3GetTasksCountResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Workflowv3GetTasksCountResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<Workflowv3GetTasksCountResponse>() {
           @Override
           public void write(JsonWriter out, Workflowv3GetTasksCountResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Workflowv3GetTasksCountResponse read(JsonReader in) throws IOException {
