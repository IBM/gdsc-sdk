...
public class HealthCollectorApi {
    ...
    /**
     * Build call for healthCollectorStoreEdgeMetrics
     * @param healthcollectorv3StoreEdgeMetricsRequest  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call healthCollectorStoreEdgeMetricsCall(Healthcollectorv3StoreEdgeMetricsRequest healthcollectorv3StoreEdgeMetricsRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = healthcollectorv3StoreEdgeMetricsRequest;

        // create path and map variables
        String localVarPath = "/api/v3/metrics/edge";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call healthCollectorStoreEdgeMetricsValidateBeforeCall(Healthcollectorv3StoreEdgeMetricsRequest healthcollectorv3StoreEdgeMetricsRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'healthcollectorv3StoreEdgeMetricsRequest' is set
        if (healthcollectorv3StoreEdgeMetricsRequest == null) {
            throw new ApiException("Missing the required parameter 'healthcollectorv3StoreEdgeMetricsRequest' when calling healthCollectorStoreEdgeMetrics(Async)");
        }

        return healthCollectorStoreEdgeMetricsCall(healthcollectorv3StoreEdgeMetricsRequest, _callback);
     ...
     */
    public Healthcollectorv3StoreEdgeMetricsResponse healthCollectorStoreEdgeMetrics(Healthcollectorv3StoreEdgeMetricsRequest healthcollectorv3StoreEdgeMetricsRequest) throws ApiException {
        ApiResponse<Healthcollectorv3StoreEdgeMetricsResponse> localVarResp = healthCollectorStoreEdgeMetricsWithHttpInfo(healthcollectorv3StoreEdgeMetricsRequest);
        return localVarResp.getData();
    }
     ...
     * 
     * @param healthcollectorv3StoreEdgeMetricsRequest  (required)
     * @return ApiResponse&lt;Healthcollectorv3StoreEdgeMetricsResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<Healthcollectorv3StoreEdgeMetricsResponse> healthCollectorStoreEdgeMetricsWithHttpInfo(Healthcollectorv3StoreEdgeMetricsRequest healthcollectorv3StoreEdgeMetricsRequest) throws ApiException {
        okhttp3.Call localVarCall = healthCollectorStoreEdgeMetricsValidateBeforeCall(healthcollectorv3StoreEdgeMetricsRequest, null);
        Type localVarReturnType = new TypeToken<Healthcollectorv3StoreEdgeMetricsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Summary: Store Edge metrics Description: Store telemetry data from the Edge&#39;s connected to GI. (asynchronously)
     * 
     * @param healthcollectorv3StoreEdgeMetricsRequest  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call healthCollectorStoreEdgeMetricsAsync(Healthcollectorv3StoreEdgeMetricsRequest healthcollectorv3StoreEdgeMetricsRequest, final ApiCallback<Healthcollectorv3StoreEdgeMetricsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = healthCollectorStoreEdgeMetricsValidateBeforeCall(healthcollectorv3StoreEdgeMetricsRequest, _callback);
        Type localVarReturnType = new TypeToken<Healthcollectorv3StoreEdgeMetricsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
