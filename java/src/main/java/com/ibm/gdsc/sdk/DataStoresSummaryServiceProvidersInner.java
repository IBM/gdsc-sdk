...
public class DataStoresSummaryServiceProvidersInner {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DataStoresSummaryServiceProvidersInner dataStoresSummaryServiceProvidersInner = (DataStoresSummaryServiceProvidersInner) o;
    return Objects.equals(this.serviceProvider, dataStoresSummaryServiceProvidersInner.serviceProvider) &&
        Objects.equals(this.count, dataStoresSummaryServiceProvidersInner.count);
  }

  @Override
  public int hashCode() {
    return Objects.hash(serviceProvider, count);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DataStoresSummaryServiceProvidersInner {\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DataStoresSummaryServiceProvidersInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DataStoresSummaryServiceProvidersInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DataStoresSummaryServiceProvidersInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DataStoresSummaryServiceProvidersInner.class));

       return (TypeAdapter<T>) new TypeAdapter<DataStoresSummaryServiceProvidersInner>() {
           @Override
           public void write(JsonWriter out, DataStoresSummaryServiceProvidersInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DataStoresSummaryServiceProvidersInner read(JsonReader in) throws IOException {
