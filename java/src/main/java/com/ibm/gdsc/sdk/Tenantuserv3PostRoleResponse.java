...
public class Tenantuserv3PostRoleResponse {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Tenantuserv3PostRoleResponse tenantuserv3PostRoleResponse = (Tenantuserv3PostRoleResponse) o;
    return Objects.equals(this.roleId, tenantuserv3PostRoleResponse.roleId);
  }
  ...
  public String toString() {
    ...
    sb.append("class Tenantuserv3PostRoleResponse {\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Tenantuserv3PostRoleResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Tenantuserv3PostRoleResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Tenantuserv3PostRoleResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Tenantuserv3PostRoleResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<Tenantuserv3PostRoleResponse>() {
           @Override
           public void write(JsonWriter out, Tenantuserv3PostRoleResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Tenantuserv3PostRoleResponse read(JsonReader in) throws IOException {
