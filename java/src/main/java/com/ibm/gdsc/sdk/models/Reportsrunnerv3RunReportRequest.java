...
public class Reportsrunnerv3RunReportRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(calculateFacets, dateRange, defaultChartExpanded, fetchSize, jobType, modelType, offset, reportDefinition, reportId, runtimeParameterList, timeZone, useQuickFacets, withoutLimit);
  }
