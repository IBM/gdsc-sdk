...
public class ListDataResourcesSortParameter {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ListDataResourcesSortParameter listDataResourcesSortParameter = (ListDataResourcesSortParameter) o;
    return Objects.equals(this.sortBy, listDataResourcesSortParameter.sortBy) &&
        Objects.equals(this.sortOrder, listDataResourcesSortParameter.sortOrder);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListDataResourcesSortParameter {\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListDataResourcesSortParameter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListDataResourcesSortParameter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListDataResourcesSortParameter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListDataResourcesSortParameter.class));

       return (TypeAdapter<T>) new TypeAdapter<ListDataResourcesSortParameter>() {
           @Override
           public void write(JsonWriter out, ListDataResourcesSortParameter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListDataResourcesSortParameter read(JsonReader in) throws IOException {
