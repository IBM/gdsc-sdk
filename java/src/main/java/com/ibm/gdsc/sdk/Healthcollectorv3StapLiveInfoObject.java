...
public class Healthcollectorv3StapLiveInfoObject {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Healthcollectorv3StapLiveInfoObject healthcollectorv3StapLiveInfoObject = (Healthcollectorv3StapLiveInfoObject) o;
    return Objects.equals(this.hasEvent, healthcollectorv3StapLiveInfoObject.hasEvent) &&
        Objects.equals(this.healthStatus, healthcollectorv3StapLiveInfoObject.healthStatus) &&
        Objects.equals(this.livelinessState, healthcollectorv3StapLiveInfoObject.livelinessState) &&
        Objects.equals(this.stap, healthcollectorv3StapLiveInfoObject.stap);
  }
  ...
  public String toString() {
    ...
    sb.append("class Healthcollectorv3StapLiveInfoObject {\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Healthcollectorv3StapLiveInfoObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Healthcollectorv3StapLiveInfoObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Healthcollectorv3StapLiveInfoObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Healthcollectorv3StapLiveInfoObject.class));

       return (TypeAdapter<T>) new TypeAdapter<Healthcollectorv3StapLiveInfoObject>() {
           @Override
           public void write(JsonWriter out, Healthcollectorv3StapLiveInfoObject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Healthcollectorv3StapLiveInfoObject read(JsonReader in) throws IOException {
