...
import com.ibm.gdsc.sdk.models.Riskanalyticscontrollerv3EnableDisableRiskEventFeedbackRequest;
import com.ibm.gdsc.sdk.models.Riskanalyticscontrollerv3EnableDisableRiskEventFeedbackResponse;
import com.ibm.gdsc.sdk.models.Riskanalyticscontrollerv3EnableDisableRiskEventProcessRequest;
import com.ibm.gdsc.sdk.models.Riskanalyticscontrollerv3EnableDisableRiskEventProcessResponse;
import com.ibm.gdsc.sdk.models.Riskanalyticscontrollerv3GetAllClassificationsListResponse;
import com.ibm.gdsc.sdk.models.Riskanalyticscontrollerv3GetRiskEventClassificationsListResponse;
import com.ibm.gdsc.sdk.models.Riskanalyticscontrollerv3GetRiskEventDetailsResponse;
import com.ibm.gdsc.sdk.models.Riskanalyticscontrollerv3GetRiskEventProcessStatusResponse;
import com.ibm.gdsc.sdk.models.Riskanalyticscontrollerv3GetRiskEventRowResponse;
import com.ibm.gdsc.sdk.models.Riskanalyticscontrollerv3GetRiskFeedbackResponse;
import com.ibm.gdsc.sdk.models.Riskanalyticscontrollerv3GetRiskObservationDetailsResponse;
import com.ibm.gdsc.sdk.models.Riskanalyticscontrollerv3GetUserUISettingsResponse;
import com.ibm.gdsc.sdk.models.Riskanalyticscontrollerv3RiskEventSummarizationDataResponse;
import com.ibm.gdsc.sdk.models.Riskanalyticscontrollerv3RiskEventTuningRequest;
import com.ibm.gdsc.sdk.models.Riskanalyticscontrollerv3RiskEventTuningResponse;
import com.ibm.gdsc.sdk.models.Riskanalyticscontrollerv3RiskEventVulnerabilityAssessmentDetailsResponse;
import com.ibm.gdsc.sdk.models.Riskanalyticscontrollerv3SetRiskEventStatusRequest;
import com.ibm.gdsc.sdk.models.Riskanalyticscontrollerv3SetRiskEventStatusResponse;
import com.ibm.gdsc.sdk.models.Riskanalyticscontrollerv3SetUserUISettingsRequest;
import com.ibm.gdsc.sdk.models.Riskanalyticscontrollerv3SetUserUISettingsResponse;
import com.ibm.gdsc.sdk.models.Riskanalyticscontrollerv3UpdateRiskFeedbackRequest;
import com.ibm.gdsc.sdk.models.Riskanalyticscontrollerv3UpdateRiskFeedbackResponse;
...
public class RiskAnalyticsControllerApi {
    ...
    public okhttp3.Call riskAnalyticsControllerGetRiskEventClassificationsListCall(Integer riskId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v3/risk_events/feedback/{risk_id}"
    ...
    public okhttp3.Call riskAnalyticsControllerGetRiskEventDataForSummarizationCall(Integer riskId, Boolean includeIndicators, Integer numFindingsLimit, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v3/risk_events/summarization/data/{risk_id}"
            .replace("{" + "risk_id" + "}", localVarApiClient.escapeString(riskId.toString()));
    ...
    public okhttp3.Call riskAnalyticsControllerGetRiskEventDetailsCall(Integer riskId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v3/risk_events/details/{risk_id}"
            .replace("{" + "risk_id" + "}", localVarApiClient.escapeString(riskId.toString()));
    ...
    public okhttp3.Call riskAnalyticsControllerGetRiskEventVulnerabilityAssessmentDetailsCall(Integer riskId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/v3/risk_events/va/{risk_id}"
            .replace("{" + "risk_id" + "}", localVarApiClient.escapeString(riskId.toString()));
    ...
    /**
     * Summary: Set user UI settings Description: Set the user settings by user id in the mongo collection. WARNING: this API should not be used manually or by a system external to Guardium Insights. Using this API to change a user settings may prevent the user from using the Risk Event function within Guardium Insights. (asynchronously)
     * 
     * @param riskanalyticscontrollerv3SetUserUISettingsRequest  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
