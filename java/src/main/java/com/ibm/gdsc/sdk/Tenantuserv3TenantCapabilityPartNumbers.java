...
public class Tenantuserv3TenantCapabilityPartNumbers {
  ...
  public Tenantuserv3TenantCapabilityPartNumbers addAddedPartNumbersItem(String addedPartNumbersItem) {
    if (this.addedPartNumbers == null) {
      this.addedPartNumbers = new ArrayList<>();
    }
    this.addedPartNumbers.add(addedPartNumbersItem);
    return this;
  }
  ...
  **/
  ...
  public Tenantuserv3TenantCapabilityPartNumbers addDeletedPartNumbersItem(String deletedPartNumbersItem) {
    if (this.deletedPartNumbers == null) {
      this.deletedPartNumbers = new ArrayList<>();
    }
    this.deletedPartNumbers.add(deletedPartNumbersItem);
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Tenantuserv3TenantCapabilityPartNumbers tenantuserv3TenantCapabilityPartNumbers = (Tenantuserv3TenantCapabilityPartNumbers) o;
    return Objects.equals(this.addedPartNumbers, tenantuserv3TenantCapabilityPartNumbers.addedPartNumbers) &&
        Objects.equals(this.deletedPartNumbers, tenantuserv3TenantCapabilityPartNumbers.deletedPartNumbers);
  }

  @Override
  public int hashCode() {
    return Objects.hash(addedPartNumbers, deletedPartNumbers);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Tenantuserv3TenantCapabilityPartNumbers {\n");
    sb.append("    addedPartNumbers: ").append(toIndentedString(addedPartNumbers)).append("\n");
    sb.append("    deletedPartNumbers: ").append(toIndentedString(deletedPartNumbers)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Tenantuserv3TenantCapabilityPartNumbers.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Tenantuserv3TenantCapabilityPartNumbers' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Tenantuserv3TenantCapabilityPartNumbers> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Tenantuserv3TenantCapabilityPartNumbers.class));

       return (TypeAdapter<T>) new TypeAdapter<Tenantuserv3TenantCapabilityPartNumbers>() {
           @Override
           public void write(JsonWriter out, Tenantuserv3TenantCapabilityPartNumbers value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Tenantuserv3TenantCapabilityPartNumbers read(JsonReader in) throws IOException {
