...
import com.ibm.gdsc.sdk.models.Universalconnectormanagerv3PluginDefinition;
...
public class Universalconnectormanagerv3PluginsListResponse {
  ...
  public Universalconnectormanagerv3PluginsListResponse addPluginsItem(Universalconnectormanagerv3PluginDefinition pluginsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Universalconnectormanagerv3PluginsListResponse universalconnectormanagerv3PluginsListResponse = (Universalconnectormanagerv3PluginsListResponse) o;
    return Objects.equals(this.plugins, universalconnectormanagerv3PluginsListResponse.plugins) &&
        Objects.equals(this.status, universalconnectormanagerv3PluginsListResponse.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class Universalconnectormanagerv3PluginsListResponse {\n");
  ...
  */
      ...
      if (jsonObj.get("plugins") != null && !jsonObj.get("plugins").isJsonNull()) {
        ...
        if (jsonArrayplugins != null) {
          ...
          for (int i = 0; i < jsonArrayplugins.size(); i++) {
            Universalconnectormanagerv3PluginDefinition.validateJsonElement(jsonArrayplugins.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Universalconnectormanagerv3PluginsListResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Universalconnectormanagerv3PluginsListResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Universalconnectormanagerv3PluginsListResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Universalconnectormanagerv3PluginsListResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<Universalconnectormanagerv3PluginsListResponse>() {
           @Override
           public void write(JsonWriter out, Universalconnectormanagerv3PluginsListResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Universalconnectormanagerv3PluginsListResponse read(JsonReader in) throws IOException {
