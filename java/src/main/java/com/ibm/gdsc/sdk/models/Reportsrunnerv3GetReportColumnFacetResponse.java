...
public class Reportsrunnerv3GetReportColumnFacetResponse {
  ...
  public Reportsrunnerv3GetReportColumnFacetResponse addFacetItem(Reportsrunnerv3Filter facetItem) {
    if (this.facet == null) {
      this.facet = new ArrayList<>();
    }
    this.facet.add(facetItem);
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Reportsrunnerv3GetReportColumnFacetResponse reportsrunnerv3GetReportColumnFacetResponse = (Reportsrunnerv3GetReportColumnFacetResponse) o;
    return Objects.equals(this.facet, reportsrunnerv3GetReportColumnFacetResponse.facet) &&
        Objects.equals(this.facetSelectedHeader, reportsrunnerv3GetReportColumnFacetResponse.facetSelectedHeader);
  }

  @Override
  public int hashCode() {
    return Objects.hash(facet, facetSelectedHeader);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Reportsrunnerv3GetReportColumnFacetResponse {\n");
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("facet") != null && !jsonObj.get("facet").isJsonNull()) {
        JsonArray jsonArrayfacet = jsonObj.getAsJsonArray("facet");
        if (jsonArrayfacet != null) {
          ...
          for (int i = 0; i < jsonArrayfacet.size(); i++) {
            Reportsrunnerv3Filter.validateJsonElement(jsonArrayfacet.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Reportsrunnerv3GetReportColumnFacetResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Reportsrunnerv3GetReportColumnFacetResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Reportsrunnerv3GetReportColumnFacetResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Reportsrunnerv3GetReportColumnFacetResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<Reportsrunnerv3GetReportColumnFacetResponse>() {
           @Override
           public void write(JsonWriter out, Reportsrunnerv3GetReportColumnFacetResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Reportsrunnerv3GetReportColumnFacetResponse read(JsonReader in) throws IOException {
