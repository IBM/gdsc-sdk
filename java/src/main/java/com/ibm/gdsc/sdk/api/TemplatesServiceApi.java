...
import com.ibm.gdsc.sdk.models.Templatesv3CreateIntegrationRequest;
import com.ibm.gdsc.sdk.models.Templatesv3CreateIntegrationResponse;
import com.ibm.gdsc.sdk.models.Templatesv3CreateTemplateRequest;
import com.ibm.gdsc.sdk.models.Templatesv3CreateTemplateResponse;
import com.ibm.gdsc.sdk.models.Templatesv3DeleteIntegrationResponse;
import com.ibm.gdsc.sdk.models.Templatesv3DeleteTemplateResponse;
import com.ibm.gdsc.sdk.models.Templatesv3GetOriginDefaultContentResponse;
import com.ibm.gdsc.sdk.models.Templatesv3GetOriginFieldsResponse;
import com.ibm.gdsc.sdk.models.Templatesv3GetTemplateResponse;
import com.ibm.gdsc.sdk.models.Templatesv3GetTemplatesForEdgeResponse;
import com.ibm.gdsc.sdk.models.Templatesv3GetTemplatesResponse;
import com.ibm.gdsc.sdk.models.Templatesv3TestTemplateRequest;
import com.ibm.gdsc.sdk.models.Templatesv3TestTemplateResponse;
import com.ibm.gdsc.sdk.models.Templatesv3TransformTemplateJSONRequest;
import com.ibm.gdsc.sdk.models.Templatesv3TransformTemplateJSONResponse;
import com.ibm.gdsc.sdk.models.Templatesv3TransformTemplateRequest;
import com.ibm.gdsc.sdk.models.Templatesv3TransformTemplateResponse;
import com.ibm.gdsc.sdk.models.Templatesv3UpdateTemplateRequest;
import com.ibm.gdsc.sdk.models.Templatesv3UpdateTemplateResponse;
...
public class TemplatesServiceApi {
    ...
    /**
     * Build call for templatesServiceGetTemplatesForEdge
     * @param integrationId Templates associated with a specific integration. (optional)
     * @param filterOrigin Filter on a specific set of data origins; ignored if empty. (optional)
     * @param filterEnabledOnly Filter on all templates instead of just the enabled templates. (optional)
     * @param includeIntegrationName Include the Integration name in the returned templates. (optional)
     * @param transformToGdpFormat Tranform template format to GDP style format. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call templatesServiceGetTemplatesForEdgeCall(String integrationId, List<String> filterOrigin, Boolean filterEnabledOnly, Boolean includeIntegrationName, Boolean transformToGdpFormat, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/v3/templates/edge";
        ...
        if (transformToGdpFormat != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("transform_to_gdp_format", transformToGdpFormat));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call templatesServiceGetTemplatesForEdgeValidateBeforeCall(String integrationId, List<String> filterOrigin, Boolean filterEnabledOnly, Boolean includeIntegrationName, Boolean transformToGdpFormat, final ApiCallback _callback) throws ApiException {
        return templatesServiceGetTemplatesForEdgeCall(integrationId, filterOrigin, filterEnabledOnly, includeIntegrationName, transformToGdpFormat, _callback);
     ...
     */
    public Templatesv3GetTemplatesForEdgeResponse templatesServiceGetTemplatesForEdge(String integrationId, List<String> filterOrigin, Boolean filterEnabledOnly, Boolean includeIntegrationName, Boolean transformToGdpFormat) throws ApiException {
        ApiResponse<Templatesv3GetTemplatesForEdgeResponse> localVarResp = templatesServiceGetTemplatesForEdgeWithHttpInfo(integrationId, filterOrigin, filterEnabledOnly, includeIntegrationName, transformToGdpFormat);
        return localVarResp.getData();
    }
     ...
     * @param includeIntegrationName Include the Integration name in the returned templates. (optional)
     * @param transformToGdpFormat Tranform template format to GDP style format. (optional)
     * @return ApiResponse&lt;Templatesv3GetTemplatesForEdgeResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<Templatesv3GetTemplatesForEdgeResponse> templatesServiceGetTemplatesForEdgeWithHttpInfo(String integrationId, List<String> filterOrigin, Boolean filterEnabledOnly, Boolean includeIntegrationName, Boolean transformToGdpFormat) throws ApiException {
        okhttp3.Call localVarCall = templatesServiceGetTemplatesForEdgeValidateBeforeCall(integrationId, filterOrigin, filterEnabledOnly, includeIntegrationName, transformToGdpFormat, null);
        Type localVarReturnType = new TypeToken<Templatesv3GetTemplatesForEdgeResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Summary: Get templates for edge Description: Return all templates based on supplied filters. (asynchronously)
     * 
     * @param integrationId Templates associated with a specific integration. (optional)
     * @param filterOrigin Filter on a specific set of data origins; ignored if empty. (optional)
     * @param filterEnabledOnly Filter on all templates instead of just the enabled templates. (optional)
     ...
     */
    public okhttp3.Call templatesServiceGetTemplatesForEdgeAsync(String integrationId, List<String> filterOrigin, Boolean filterEnabledOnly, Boolean includeIntegrationName, Boolean transformToGdpFormat, final ApiCallback<Templatesv3GetTemplatesForEdgeResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = templatesServiceGetTemplatesForEdgeValidateBeforeCall(integrationId, filterOrigin, filterEnabledOnly, includeIntegrationName, transformToGdpFormat, _callback);
        Type localVarReturnType = new TypeToken<Templatesv3GetTemplatesForEdgeResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
