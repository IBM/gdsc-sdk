...
import com.ibm.gdsc.sdk.models.Featureflagsv3FeatureFlagValue;
...
public class AuthserverGetPrivilegesResponse {
  ...
  public AuthserverGetPrivilegesResponse putFeatureFlagsItem(String key, Featureflagsv3FeatureFlagValue featureFlagsItem) {
  ...
  **/
  ...
  public AuthserverGetPrivilegesResponse putPrivilegesItem(String key, Boolean privilegesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AuthserverGetPrivilegesResponse authserverGetPrivilegesResponse = (AuthserverGetPrivilegesResponse) o;
    return Objects.equals(this.featureFlags, authserverGetPrivilegesResponse.featureFlags) &&
        Objects.equals(this.privileges, authserverGetPrivilegesResponse.privileges);
  }

  @Override
  public int hashCode() {
    return Objects.hash(featureFlags, privileges);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AuthserverGetPrivilegesResponse {\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthserverGetPrivilegesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthserverGetPrivilegesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthserverGetPrivilegesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthserverGetPrivilegesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthserverGetPrivilegesResponse>() {
           @Override
           public void write(JsonWriter out, AuthserverGetPrivilegesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuthserverGetPrivilegesResponse read(JsonReader in) throws IOException {
