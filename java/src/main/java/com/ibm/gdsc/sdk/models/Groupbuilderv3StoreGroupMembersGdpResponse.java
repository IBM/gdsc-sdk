...
public class Groupbuilderv3StoreGroupMembersGdpResponse {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Groupbuilderv3StoreGroupMembersGdpResponse groupbuilderv3StoreGroupMembersGdpResponse = (Groupbuilderv3StoreGroupMembersGdpResponse) o;
    return Objects.equals(this.response, groupbuilderv3StoreGroupMembersGdpResponse.response) &&
        Objects.equals(this.responseCode, groupbuilderv3StoreGroupMembersGdpResponse.responseCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class Groupbuilderv3StoreGroupMembersGdpResponse {\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Groupbuilderv3StoreGroupMembersGdpResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Groupbuilderv3StoreGroupMembersGdpResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Groupbuilderv3StoreGroupMembersGdpResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Groupbuilderv3StoreGroupMembersGdpResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<Groupbuilderv3StoreGroupMembersGdpResponse>() {
           @Override
           public void write(JsonWriter out, Groupbuilderv3StoreGroupMembersGdpResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Groupbuilderv3StoreGroupMembersGdpResponse read(JsonReader in) throws IOException {
