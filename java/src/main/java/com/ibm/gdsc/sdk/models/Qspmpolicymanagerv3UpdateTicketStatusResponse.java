...
public class Qspmpolicymanagerv3UpdateTicketStatusResponse {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Qspmpolicymanagerv3UpdateTicketStatusResponse qspmpolicymanagerv3UpdateTicketStatusResponse = (Qspmpolicymanagerv3UpdateTicketStatusResponse) o;
    return Objects.equals(this.message, qspmpolicymanagerv3UpdateTicketStatusResponse.message) &&
        Objects.equals(this.newStatus, qspmpolicymanagerv3UpdateTicketStatusResponse.newStatus) &&
        Objects.equals(this.updateTime, qspmpolicymanagerv3UpdateTicketStatusResponse.updateTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(message, newStatus, updateTime);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Qspmpolicymanagerv3UpdateTicketStatusResponse {\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Qspmpolicymanagerv3UpdateTicketStatusResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Qspmpolicymanagerv3UpdateTicketStatusResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Qspmpolicymanagerv3UpdateTicketStatusResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Qspmpolicymanagerv3UpdateTicketStatusResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<Qspmpolicymanagerv3UpdateTicketStatusResponse>() {
           @Override
           public void write(JsonWriter out, Qspmpolicymanagerv3UpdateTicketStatusResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Qspmpolicymanagerv3UpdateTicketStatusResponse read(JsonReader in) throws IOException {
