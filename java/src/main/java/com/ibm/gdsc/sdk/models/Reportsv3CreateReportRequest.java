...
public class Reportsv3CreateReportRequest {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Reportsv3CreateReportRequest reportsv3CreateReportRequest = (Reportsv3CreateReportRequest) o;
    return Objects.equals(this.reportDefinition, reportsv3CreateReportRequest.reportDefinition);
  }
  ...
  public String toString() {
    ...
    sb.append("class Reportsv3CreateReportRequest {\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Reportsv3CreateReportRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Reportsv3CreateReportRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Reportsv3CreateReportRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Reportsv3CreateReportRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<Reportsv3CreateReportRequest>() {
           @Override
           public void write(JsonWriter out, Reportsv3CreateReportRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Reportsv3CreateReportRequest read(JsonReader in) throws IOException {
