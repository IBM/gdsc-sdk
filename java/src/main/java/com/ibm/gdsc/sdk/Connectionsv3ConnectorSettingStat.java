...
public class Connectionsv3ConnectorSettingStat {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Connectionsv3ConnectorSettingStat connectionsv3ConnectorSettingStat = (Connectionsv3ConnectorSettingStat) o;
    return Objects.equals(this.count, connectionsv3ConnectorSettingStat.count) &&
        Objects.equals(this.hasUnhealthy, connectionsv3ConnectorSettingStat.hasUnhealthy) &&
        Objects.equals(this.id, connectionsv3ConnectorSettingStat.id);
  }

  @Override
  public int hashCode() {
    return Objects.hash(count, hasUnhealthy, id);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Connectionsv3ConnectorSettingStat {\n");
    sb.append("    count: ").append(toIndentedString(count)).append("\n");
    sb.append("    hasUnhealthy: ").append(toIndentedString(hasUnhealthy)).append("\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Connectionsv3ConnectorSettingStat.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Connectionsv3ConnectorSettingStat' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Connectionsv3ConnectorSettingStat> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Connectionsv3ConnectorSettingStat.class));

       return (TypeAdapter<T>) new TypeAdapter<Connectionsv3ConnectorSettingStat>() {
           @Override
           public void write(JsonWriter out, Connectionsv3ConnectorSettingStat value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Connectionsv3ConnectorSettingStat read(JsonReader in) throws IOException {
