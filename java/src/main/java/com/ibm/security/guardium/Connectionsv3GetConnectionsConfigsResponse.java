...
public class Connectionsv3GetConnectionsConfigsResponse {
  ...
  public Connectionsv3GetConnectionsConfigsResponse streamConnectionConfigs(@javax.annotation.Nullable List<Connectionsv3StreamConnectionConfig> streamConnectionConfigs) {
  ...
  public Connectionsv3GetConnectionsConfigsResponse ucConnectionConfigs(@javax.annotation.Nullable List<Connectionsv3UCConnectionConfig> ucConnectionConfigs) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("stream_connection_configs", "uc_connection_configs"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Connectionsv3GetConnectionsConfigsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Connectionsv3GetConnectionsConfigsResponse is not found in the empty JSON string", Connectionsv3GetConnectionsConfigsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Connectionsv3GetConnectionsConfigsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Connectionsv3GetConnectionsConfigsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
