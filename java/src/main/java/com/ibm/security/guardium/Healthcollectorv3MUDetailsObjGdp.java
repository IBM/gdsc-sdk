...
import com.ibm.security.guardium.Healthcollectorv3AggregationDetailsObjectGdp;
import com.ibm.security.guardium.Healthcollectorv3GeneralDetailsObject;
import com.ibm.security.guardium.Healthcollectorv3UtilizationParameterObjectGdp;
...
public class Healthcollectorv3MUDetailsObjGdp {
  ...
  public Healthcollectorv3MUDetailsObjGdp aggHealthViewList(@javax.annotation.Nullable List<Healthcollectorv3AggregationDetailsObjectGdp> aggHealthViewList) {
  ...
  public void setAggHealthViewList(@javax.annotation.Nullable List<Healthcollectorv3AggregationDetailsObjectGdp> aggHealthViewList) {
    this.aggHealthViewList = aggHealthViewList;
  }


  public Healthcollectorv3MUDetailsObjGdp connectivityDetails(@javax.annotation.Nullable Healthcollectorv3GeneralDetailsObject connectivityDetails) {
  ...
  public Healthcollectorv3MUDetailsObjGdp generalErrMessages(@javax.annotation.Nullable List<String> generalErrMessages) {
  ...
  public Healthcollectorv3MUDetailsObjGdp utilizationScheme(@javax.annotation.Nullable Healthcollectorv3UtilizationParameterObjectGdp utilizationScheme) {
  ...
  public void setUtilizationScheme(@javax.annotation.Nullable Healthcollectorv3UtilizationParameterObjectGdp utilizationScheme) {
    this.utilizationScheme = utilizationScheme;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Healthcollectorv3MUDetailsObjGdp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Healthcollectorv3MUDetailsObjGdp is not found in the empty JSON string", Healthcollectorv3MUDetailsObjGdp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Healthcollectorv3MUDetailsObjGdp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Healthcollectorv3MUDetailsObjGdp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
