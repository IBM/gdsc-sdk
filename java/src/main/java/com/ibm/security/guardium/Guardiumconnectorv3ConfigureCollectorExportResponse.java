...
public class Guardiumconnectorv3ConfigureCollectorExportResponse {
  ...
  public Guardiumconnectorv3ConfigureCollectorExportResponse status(@javax.annotation.Nullable Guardiumconnectorv3StatusResponseBase status) {
    this.status = status;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Guardiumconnectorv3ConfigureCollectorExportResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Guardiumconnectorv3ConfigureCollectorExportResponse is not found in the empty JSON string", Guardiumconnectorv3ConfigureCollectorExportResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Guardiumconnectorv3ConfigureCollectorExportResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Guardiumconnectorv3ConfigureCollectorExportResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
