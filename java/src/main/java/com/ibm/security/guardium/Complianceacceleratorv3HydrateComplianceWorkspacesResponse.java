...
public class Complianceacceleratorv3HydrateComplianceWorkspacesResponse {
  ...
  public Complianceacceleratorv3HydrateComplianceWorkspacesResponse status(@javax.annotation.Nullable Complianceacceleratorv3StatusResponseBase status) {
    this.status = status;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Complianceacceleratorv3HydrateComplianceWorkspacesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Complianceacceleratorv3HydrateComplianceWorkspacesResponse is not found in the empty JSON string", Complianceacceleratorv3HydrateComplianceWorkspacesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Complianceacceleratorv3HydrateComplianceWorkspacesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Complianceacceleratorv3HydrateComplianceWorkspacesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
