...
public class AuthserverGetAccessTokenResponse {
  ...
  public AuthserverGetAccessTokenResponse accessToken(@javax.annotation.Nullable String accessToken) {
  ...
  public AuthserverGetAccessTokenResponse expiresIn(@javax.annotation.Nullable String expiresIn) {
  ...
  public AuthserverGetAccessTokenResponse tokenType(@javax.annotation.Nullable String tokenType) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("access_token", "expires_in", "token_type"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthserverGetAccessTokenResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AuthserverGetAccessTokenResponse is not found in the empty JSON string", AuthserverGetAccessTokenResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthserverGetAccessTokenResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AuthserverGetAccessTokenResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
