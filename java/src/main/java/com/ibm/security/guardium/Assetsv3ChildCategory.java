...
public class Assetsv3ChildCategory {
  ...
  public Assetsv3ChildCategory childId(@javax.annotation.Nullable String childId) {
  ...
  public Assetsv3ChildCategory childName(@javax.annotation.Nullable String childName) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Assetsv3ChildCategory.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Assetsv3ChildCategory is not found in the empty JSON string", Assetsv3ChildCategory.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Assetsv3ChildCategory.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Assetsv3ChildCategory` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
