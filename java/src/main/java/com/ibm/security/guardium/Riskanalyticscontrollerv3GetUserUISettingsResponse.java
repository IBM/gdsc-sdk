...
public class Riskanalyticscontrollerv3GetUserUISettingsResponse {
  ...
  public Riskanalyticscontrollerv3GetUserUISettingsResponse userUiSettings(@javax.annotation.Nullable Riskanalyticscontrollerv3UserUISettings userUiSettings) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Riskanalyticscontrollerv3GetUserUISettingsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Riskanalyticscontrollerv3GetUserUISettingsResponse is not found in the empty JSON string", Riskanalyticscontrollerv3GetUserUISettingsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Riskanalyticscontrollerv3GetUserUISettingsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Riskanalyticscontrollerv3GetUserUISettingsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
