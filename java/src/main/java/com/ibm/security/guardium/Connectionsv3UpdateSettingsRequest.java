...
public class Connectionsv3UpdateSettingsRequest {
  ...
  public Connectionsv3UpdateSettingsRequest settings(@javax.annotation.Nullable List<Connectionsv3ConnectorSetting> settings) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Connectionsv3UpdateSettingsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Connectionsv3UpdateSettingsRequest is not found in the empty JSON string", Connectionsv3UpdateSettingsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Connectionsv3UpdateSettingsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Connectionsv3UpdateSettingsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
