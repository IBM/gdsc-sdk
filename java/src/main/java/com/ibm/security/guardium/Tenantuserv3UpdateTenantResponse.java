...
public class Tenantuserv3UpdateTenantResponse {
  ...
  public Tenantuserv3UpdateTenantResponse tenantId(@javax.annotation.Nullable String tenantId) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Tenantuserv3UpdateTenantResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Tenantuserv3UpdateTenantResponse is not found in the empty JSON string", Tenantuserv3UpdateTenantResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Tenantuserv3UpdateTenantResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Tenantuserv3UpdateTenantResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
