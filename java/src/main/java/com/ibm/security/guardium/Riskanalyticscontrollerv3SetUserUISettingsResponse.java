...
public class Riskanalyticscontrollerv3SetUserUISettingsResponse {
  ...
  public Riskanalyticscontrollerv3SetUserUISettingsResponse message(@javax.annotation.Nullable String message) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Riskanalyticscontrollerv3SetUserUISettingsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Riskanalyticscontrollerv3SetUserUISettingsResponse is not found in the empty JSON string", Riskanalyticscontrollerv3SetUserUISettingsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Riskanalyticscontrollerv3SetUserUISettingsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Riskanalyticscontrollerv3SetUserUISettingsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
