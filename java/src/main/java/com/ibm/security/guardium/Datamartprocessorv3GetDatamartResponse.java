...
public class Datamartprocessorv3GetDatamartResponse {
  ...
  public Datamartprocessorv3GetDatamartResponse datamarts(@javax.annotation.Nullable List<Datamartprocessorv3DatamartInfo> datamarts) {
  ...
  public void setDatamarts(@javax.annotation.Nullable List<Datamartprocessorv3DatamartInfo> datamarts) {
    this.datamarts = datamarts;
  }


  public Datamartprocessorv3GetDatamartResponse status(@javax.annotation.Nullable Datamartprocessorv3StatusResponseBase status) {
    this.status = status;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("datamarts", "status"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Datamartprocessorv3GetDatamartResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Datamartprocessorv3GetDatamartResponse is not found in the empty JSON string", Datamartprocessorv3GetDatamartResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Datamartprocessorv3GetDatamartResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Datamartprocessorv3GetDatamartResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
