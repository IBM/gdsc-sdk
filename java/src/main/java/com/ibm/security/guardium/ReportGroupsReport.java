...
public class ReportGroupsReport {
  ...
  public boolean equals(Object o) {
    ...
    ReportGroupsReport reportGroupsReport = (ReportGroupsReport) o;
    return Objects.equals(this.reportId, reportGroupsReport.reportId) &&
        Objects.equals(this.reportName, reportGroupsReport.reportName);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReportGroupsReport {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReportGroupsReport.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReportGroupsReport' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReportGroupsReport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReportGroupsReport.class));

       return (TypeAdapter<T>) new TypeAdapter<ReportGroupsReport>() {
           @Override
           public void write(JsonWriter out, ReportGroupsReport value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReportGroupsReport read(JsonReader in) throws IOException {
