...
public class Complianceacceleratorv3AuditScheduler {
  ...
  public Complianceacceleratorv3AuditScheduler beginSchedule(@javax.annotation.Nullable OffsetDateTime beginSchedule) {
  ...
  public Complianceacceleratorv3AuditScheduler byDayOfMonth(@javax.annotation.Nullable Boolean byDayOfMonth) {
  ...
  public Complianceacceleratorv3AuditScheduler dayOfMonth(@javax.annotation.Nullable String dayOfMonth) {
  ...
  public Complianceacceleratorv3AuditScheduler dayOfWeek(@javax.annotation.Nullable List<Schedulerv3DayOfWeek> dayOfWeek) {
  ...
  public Complianceacceleratorv3AuditScheduler dayOrder(@javax.annotation.Nullable Schedulerv3DayOrder dayOrder) {
  ...
  public Complianceacceleratorv3AuditScheduler dayOrderDayOfWeek(@javax.annotation.Nullable Schedulerv3DayOfWeek dayOrderDayOfWeek) {
  ...
  public Complianceacceleratorv3AuditScheduler endSchedule(@javax.annotation.Nullable OffsetDateTime endSchedule) {
  ...
  public Complianceacceleratorv3AuditScheduler frequency(@javax.annotation.Nullable Schedulerv3Frequency frequency) {
  ...
  public Complianceacceleratorv3AuditScheduler months(@javax.annotation.Nullable List<Schedulerv3Month> months) {
    this.months = months;
    return this;
  }
  ...
  public Complianceacceleratorv3AuditScheduler neverEnd(@javax.annotation.Nullable Boolean neverEnd) {
  ...
  public Complianceacceleratorv3AuditScheduler repeat(@javax.annotation.Nullable Integer repeat) {
    this.repeat = repeat;
    return this;
  }
  ...
  public Complianceacceleratorv3AuditScheduler repeatBegin(@javax.annotation.Nullable Schedulerv3RepeatBegin repeatBegin) {
  ...
  public Complianceacceleratorv3AuditScheduler repeatEnd(@javax.annotation.Nullable Schedulerv3RepeatEnd repeatEnd) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("begin_schedule", "by_day_of_month", "day_of_month", "day_of_week", "day_order", "day_order_day_of_week", "end_schedule", "frequency", "months", "never_end", "repeat", "repeat_begin", "repeat_end"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Complianceacceleratorv3AuditScheduler.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Complianceacceleratorv3AuditScheduler is not found in the empty JSON string", Complianceacceleratorv3AuditScheduler.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Complianceacceleratorv3AuditScheduler.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Complianceacceleratorv3AuditScheduler` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
