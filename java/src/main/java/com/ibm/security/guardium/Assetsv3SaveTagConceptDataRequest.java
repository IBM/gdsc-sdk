...
public class Assetsv3SaveTagConceptDataRequest {
  ...
  public Assetsv3SaveTagConceptDataRequest tag(@javax.annotation.Nullable Assetsv3Tag tag) {
    this.tag = tag;
    return this;
  }
  ...
  public void setTag(@javax.annotation.Nullable Assetsv3Tag tag) {
    this.tag = tag;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Assetsv3SaveTagConceptDataRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Assetsv3SaveTagConceptDataRequest is not found in the empty JSON string", Assetsv3SaveTagConceptDataRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Assetsv3SaveTagConceptDataRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Assetsv3SaveTagConceptDataRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
