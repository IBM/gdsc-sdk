...
public class GroupBuilderApi {
    ...
    /**
     * Summary: Get GDP to gi group mapping Description: Get GDSC to GDP group sync mapping. (asynchronously)
     * 
     * @param centralManagerId Central manager. (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * Summary: Get group type mapping Description: Get GDSC to GDP group types mapping. (asynchronously)
     * 
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
