...
public class Riskanalyticsdataprocessorv3GetRiskContextResponse {
  ...
  public Riskanalyticsdataprocessorv3GetRiskContextResponse context(@javax.annotation.Nullable Map<String, String> context) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Riskanalyticsdataprocessorv3GetRiskContextResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Riskanalyticsdataprocessorv3GetRiskContextResponse is not found in the empty JSON string", Riskanalyticsdataprocessorv3GetRiskContextResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Riskanalyticsdataprocessorv3GetRiskContextResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Riskanalyticsdataprocessorv3GetRiskContextResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
