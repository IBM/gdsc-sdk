...
public class Jumpboxv3UpdateUsersBulkResponse {
  ...
  public Jumpboxv3UpdateUsersBulkResponse location(@javax.annotation.Nullable String location) {
  ...
  public Jumpboxv3UpdateUsersBulkResponse message(@javax.annotation.Nullable String message) {
  ...
  public Jumpboxv3UpdateUsersBulkResponse userId(@javax.annotation.Nullable List<String> userId) {
    this.userId = userId;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("location", "message", "user_id"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Jumpboxv3UpdateUsersBulkResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Jumpboxv3UpdateUsersBulkResponse is not found in the empty JSON string", Jumpboxv3UpdateUsersBulkResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Jumpboxv3UpdateUsersBulkResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Jumpboxv3UpdateUsersBulkResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
