...
public class Guardiumconnectorv3GetCMsConfigResponse {
  ...
  public Guardiumconnectorv3GetCMsConfigResponse cms(@javax.annotation.Nullable List<Guardiumconnectorv3CM> cms) {
    this.cms = cms;
    return this;
  }
  ...
  public Guardiumconnectorv3GetCMsConfigResponse status(@javax.annotation.Nullable Guardiumconnectorv3StatusResponseBase status) {
    this.status = status;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("cms", "status"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Guardiumconnectorv3GetCMsConfigResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Guardiumconnectorv3GetCMsConfigResponse is not found in the empty JSON string", Guardiumconnectorv3GetCMsConfigResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Guardiumconnectorv3GetCMsConfigResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Guardiumconnectorv3GetCMsConfigResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
