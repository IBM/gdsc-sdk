...
public class Riskanalyticsmlclassificationv3ResetModelToDefaultsResponse {
  ...
  public Riskanalyticsmlclassificationv3ResetModelToDefaultsResponse message(@javax.annotation.Nullable String message) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Riskanalyticsmlclassificationv3ResetModelToDefaultsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Riskanalyticsmlclassificationv3ResetModelToDefaultsResponse is not found in the empty JSON string", Riskanalyticsmlclassificationv3ResetModelToDefaultsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Riskanalyticsmlclassificationv3ResetModelToDefaultsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Riskanalyticsmlclassificationv3ResetModelToDefaultsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
