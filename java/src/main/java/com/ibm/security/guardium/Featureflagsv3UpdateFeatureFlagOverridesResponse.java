...
public class Featureflagsv3UpdateFeatureFlagOverridesResponse {
  ...
  public Featureflagsv3UpdateFeatureFlagOverridesResponse message(@javax.annotation.Nullable String message) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Featureflagsv3UpdateFeatureFlagOverridesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Featureflagsv3UpdateFeatureFlagOverridesResponse is not found in the empty JSON string", Featureflagsv3UpdateFeatureFlagOverridesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Featureflagsv3UpdateFeatureFlagOverridesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Featureflagsv3UpdateFeatureFlagOverridesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
