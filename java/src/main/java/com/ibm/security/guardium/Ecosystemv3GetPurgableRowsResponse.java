...
public class Ecosystemv3GetPurgableRowsResponse {
  ...
  public Ecosystemv3GetPurgableRowsResponse purgableRows(@javax.annotation.Nullable Integer purgableRows) {
  ...
  public void setPurgableRows(@javax.annotation.Nullable Integer purgableRows) {
    this.purgableRows = purgableRows;
  }


  public Ecosystemv3GetPurgableRowsResponse status(@javax.annotation.Nullable GooglerpcStatus status) {
    this.status = status;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("purgable_rows", "status"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Ecosystemv3GetPurgableRowsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Ecosystemv3GetPurgableRowsResponse is not found in the empty JSON string", Ecosystemv3GetPurgableRowsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Ecosystemv3GetPurgableRowsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Ecosystemv3GetPurgableRowsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
