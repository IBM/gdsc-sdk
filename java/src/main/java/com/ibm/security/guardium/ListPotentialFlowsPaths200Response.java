...
import com.ibm.security.guardium.PotentialFlowPathListItem;
...
public class ListPotentialFlowsPaths200Response {
  ...
  public ListPotentialFlowsPaths200Response results(@javax.annotation.Nonnull List<PotentialFlowPathListItem> results) {
  ...
  public void setResults(@javax.annotation.Nonnull List<PotentialFlowPathListItem> results) {
    this.results = results;
  }


  public ListPotentialFlowsPaths200Response nextToken(@javax.annotation.Nullable String nextToken) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListPotentialFlowsPaths200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ListPotentialFlowsPaths200Response is not found in the empty JSON string", ListPotentialFlowsPaths200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListPotentialFlowsPaths200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ListPotentialFlowsPaths200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
