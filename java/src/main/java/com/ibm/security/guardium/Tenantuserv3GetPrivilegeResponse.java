...
public class Tenantuserv3GetPrivilegeResponse {
  ...
  public Tenantuserv3GetPrivilegeResponse privilege(@javax.annotation.Nullable Tenantuserv3Privilege privilege) {
  ...
  public void setPrivilege(@javax.annotation.Nullable Tenantuserv3Privilege privilege) {
    this.privilege = privilege;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("privilege"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Tenantuserv3GetPrivilegeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Tenantuserv3GetPrivilegeResponse is not found in the empty JSON string", Tenantuserv3GetPrivilegeResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Tenantuserv3GetPrivilegeResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Tenantuserv3GetPrivilegeResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
