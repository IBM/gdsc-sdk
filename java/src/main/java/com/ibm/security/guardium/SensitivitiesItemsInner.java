...
public class SensitivitiesItemsInner {
  ...
  public SensitivitiesItemsInner sensitivity(@javax.annotation.Nonnull String sensitivity) {
  ...
  public void setSensitivity(@javax.annotation.Nonnull String sensitivity) {
    this.sensitivity = sensitivity;
  }


  public SensitivitiesItemsInner count(@javax.annotation.Nonnull BigDecimal count) {
    this.count = count;
    return this;
  }
  ...
  public SensitivitiesItemsInner category(@javax.annotation.Nonnull String category) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("sensitivity", "count", "category"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("sensitivity", "count", "category"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SensitivitiesItemsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in SensitivitiesItemsInner is not found in the empty JSON string", SensitivitiesItemsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SensitivitiesItemsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SensitivitiesItemsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("sensitivity").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sensitivity` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sensitivity").toString()));
      }
