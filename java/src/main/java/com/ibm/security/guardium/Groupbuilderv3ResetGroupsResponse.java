...
public class Groupbuilderv3ResetGroupsResponse {
  ...
  public boolean equals(Object o) {
    ...
    Groupbuilderv3ResetGroupsResponse groupbuilderv3ResetGroupsResponse = (Groupbuilderv3ResetGroupsResponse) o;
    return Objects.equals(this.status, groupbuilderv3ResetGroupsResponse.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class Groupbuilderv3ResetGroupsResponse {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Groupbuilderv3ResetGroupsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Groupbuilderv3ResetGroupsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Groupbuilderv3ResetGroupsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Groupbuilderv3ResetGroupsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<Groupbuilderv3ResetGroupsResponse>() {
           @Override
           public void write(JsonWriter out, Groupbuilderv3ResetGroupsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Groupbuilderv3ResetGroupsResponse read(JsonReader in) throws IOException {
