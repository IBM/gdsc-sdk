...
public class Complianceacceleratorv3DeleteComplianceWorkspacesResponse {
  ...
  public Complianceacceleratorv3DeleteComplianceWorkspacesResponse status(@javax.annotation.Nullable Complianceacceleratorv3StatusResponseBase status) {
    this.status = status;
    return this;
  }
  ...
  public Complianceacceleratorv3DeleteComplianceWorkspacesResponse workspaceId(@javax.annotation.Nullable String workspaceId) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Complianceacceleratorv3DeleteComplianceWorkspacesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Complianceacceleratorv3DeleteComplianceWorkspacesResponse is not found in the empty JSON string", Complianceacceleratorv3DeleteComplianceWorkspacesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Complianceacceleratorv3DeleteComplianceWorkspacesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Complianceacceleratorv3DeleteComplianceWorkspacesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
