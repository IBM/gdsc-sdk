...
public class Tenantuserv3DisableUsersBulkResponse {
  ...
  public Tenantuserv3DisableUsersBulkResponse userIds(@javax.annotation.Nullable List<String> userIds) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("user_ids"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Tenantuserv3DisableUsersBulkResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Tenantuserv3DisableUsersBulkResponse is not found in the empty JSON string", Tenantuserv3DisableUsersBulkResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Tenantuserv3DisableUsersBulkResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Tenantuserv3DisableUsersBulkResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
