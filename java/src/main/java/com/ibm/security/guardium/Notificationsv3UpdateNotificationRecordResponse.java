...
public class Notificationsv3UpdateNotificationRecordResponse {
  ...
  public Notificationsv3UpdateNotificationRecordResponse result(@javax.annotation.Nullable String result) {
    this.result = result;
    return this;
  }
  ...
  public Notificationsv3UpdateNotificationRecordResponse status(@javax.annotation.Nullable RpcStatus status) {
    this.status = status;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Notificationsv3UpdateNotificationRecordResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Notificationsv3UpdateNotificationRecordResponse is not found in the empty JSON string", Notificationsv3UpdateNotificationRecordResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Notificationsv3UpdateNotificationRecordResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Notificationsv3UpdateNotificationRecordResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
