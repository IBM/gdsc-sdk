...
public class QsPolicyManagerApi {
    ...
    /**
     * Build call for qSPolicyManagerConfigUpdate
     * @param qspmpolicymanagerv3UpdateConfigsRequest  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    public okhttp3.Call qSPolicyManagerConfigUpdateCall(Qspmpolicymanagerv3UpdateConfigsRequest qspmpolicymanagerv3UpdateConfigsRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = qspmpolicymanagerv3UpdateConfigsRequest;

        // create path and map variables
        String localVarPath = "/api/v3/policy_manager/configs";
    ...
    private okhttp3.Call qSPolicyManagerConfigUpdateValidateBeforeCall(Qspmpolicymanagerv3UpdateConfigsRequest qspmpolicymanagerv3UpdateConfigsRequest, final ApiCallback _callback) throws ApiException {
        ...
        return qSPolicyManagerConfigUpdateCall(qspmpolicymanagerv3UpdateConfigsRequest, _callback);
    ...
    /**
     * ConfigUpdate - this function update Crypto Risk Factor Weight in Db2 as well as Mongodb. (asynchronously)
     * 
     * @param qspmpolicymanagerv3UpdateConfigsRequest  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
