...
public class Policybuilderv3InsertGdpPolicyMetaDataResponse {
  ...
  public Policybuilderv3InsertGdpPolicyMetaDataResponse status(@javax.annotation.Nullable Policybuilderv3StatusResponseBase status) {
    this.status = status;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Policybuilderv3InsertGdpPolicyMetaDataResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Policybuilderv3InsertGdpPolicyMetaDataResponse is not found in the empty JSON string", Policybuilderv3InsertGdpPolicyMetaDataResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Policybuilderv3InsertGdpPolicyMetaDataResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Policybuilderv3InsertGdpPolicyMetaDataResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
