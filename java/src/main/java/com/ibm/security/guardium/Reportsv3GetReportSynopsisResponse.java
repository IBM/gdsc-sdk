...
public class Reportsv3GetReportSynopsisResponse {
  ...
  public Reportsv3GetReportSynopsisResponse report(@javax.annotation.Nullable Reportsv3BriefReport report) {
    this.report = report;
    return this;
  }
  ...
  public void setReport(@javax.annotation.Nullable Reportsv3BriefReport report) {
    this.report = report;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Reportsv3GetReportSynopsisResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Reportsv3GetReportSynopsisResponse is not found in the empty JSON string", Reportsv3GetReportSynopsisResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Reportsv3GetReportSynopsisResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Reportsv3GetReportSynopsisResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
