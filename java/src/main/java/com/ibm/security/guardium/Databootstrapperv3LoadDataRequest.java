...
public class Databootstrapperv3LoadDataRequest {
  ...
  public Databootstrapperv3LoadDataRequest partNumber(@javax.annotation.Nullable String partNumber) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("part_number"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Databootstrapperv3LoadDataRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Databootstrapperv3LoadDataRequest is not found in the empty JSON string", Databootstrapperv3LoadDataRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Databootstrapperv3LoadDataRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Databootstrapperv3LoadDataRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
