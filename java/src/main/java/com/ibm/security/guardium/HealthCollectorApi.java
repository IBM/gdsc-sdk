...
import com.ibm.security.guardium.Healthcollectorv3GetDataWarehouseUsageResponse;
import com.ibm.security.guardium.Healthcollectorv3GetGDPHealthInfoResponse;
import com.ibm.security.guardium.Healthcollectorv3GetHistoricalHealthInfoResponse;
import com.ibm.security.guardium.Healthcollectorv3GetObjectStorageUsageResponse;
import com.ibm.security.guardium.Healthcollectorv3GetPVCUsageResponse;
import com.ibm.security.guardium.Healthcollectorv3GetPodRestartsResponse;
import com.ibm.security.guardium.Healthcollectorv3GetStreamsIngestionResponse;
import com.ibm.security.guardium.Healthcollectorv3GetTopGDPCollectorsResponse;
import com.ibm.security.guardium.Healthcollectorv3StoreHealthInfoRequest;
import com.ibm.security.guardium.Healthcollectorv3StoreHealthInfoResponse;
...
public class HealthCollectorApi {
    ...
    /**
     * Summary: Get data warehouse usage info Description: Get information from data warehouse related to usage (asynchronously)
     * 
     * @param type The type of metric to retrieve (required)
     * @param startTime The start time from which the data needs to be calculated. (optional)
     * @param endTime The end time from which the data needs to be calculated. (optional)
