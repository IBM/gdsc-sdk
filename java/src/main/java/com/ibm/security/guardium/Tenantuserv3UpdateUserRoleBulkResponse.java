...
public class Tenantuserv3UpdateUserRoleBulkResponse {
  ...
  public Tenantuserv3UpdateUserRoleBulkResponse message(@javax.annotation.Nullable String message) {
  ...
  public Tenantuserv3UpdateUserRoleBulkResponse userId(@javax.annotation.Nullable List<String> userId) {
    this.userId = userId;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("message", "user_id"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Tenantuserv3UpdateUserRoleBulkResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Tenantuserv3UpdateUserRoleBulkResponse is not found in the empty JSON string", Tenantuserv3UpdateUserRoleBulkResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Tenantuserv3UpdateUserRoleBulkResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Tenantuserv3UpdateUserRoleBulkResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
