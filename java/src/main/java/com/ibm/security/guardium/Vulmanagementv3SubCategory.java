...
public class Vulmanagementv3SubCategory {
  ...
  public Vulmanagementv3SubCategory addChildrenCategoryItem(Vulmanagementv3ChildCategory childrenCategoryItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Vulmanagementv3SubCategory vulmanagementv3SubCategory = (Vulmanagementv3SubCategory) o;
    return Objects.equals(this.childrenCategory, vulmanagementv3SubCategory.childrenCategory) &&
        Objects.equals(this.id, vulmanagementv3SubCategory.id) &&
        Objects.equals(this.name, vulmanagementv3SubCategory.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class Vulmanagementv3SubCategory {\n");
  ...
  */
      ...
      if (jsonObj.get("children_category") != null && !jsonObj.get("children_category").isJsonNull()) {
        ...
        if (jsonArraychildrenCategory != null) {
          ...
          for (int i = 0; i < jsonArraychildrenCategory.size(); i++) {
            Vulmanagementv3ChildCategory.validateJsonElement(jsonArraychildrenCategory.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Vulmanagementv3SubCategory.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Vulmanagementv3SubCategory' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Vulmanagementv3SubCategory> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Vulmanagementv3SubCategory.class));

       return (TypeAdapter<T>) new TypeAdapter<Vulmanagementv3SubCategory>() {
           @Override
           public void write(JsonWriter out, Vulmanagementv3SubCategory value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Vulmanagementv3SubCategory read(JsonReader in) throws IOException {
