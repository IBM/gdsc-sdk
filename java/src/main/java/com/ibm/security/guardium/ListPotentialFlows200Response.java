...
public class ListPotentialFlows200Response {
  ...
  public ListPotentialFlows200Response results(@javax.annotation.Nonnull List<PotentialFlowListItem> results) {
  ...
  public void setResults(@javax.annotation.Nonnull List<PotentialFlowListItem> results) {
    this.results = results;
  }


  public ListPotentialFlows200Response nextToken(@javax.annotation.Nullable String nextToken) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListPotentialFlows200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ListPotentialFlows200Response is not found in the empty JSON string", ListPotentialFlows200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListPotentialFlows200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ListPotentialFlows200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
