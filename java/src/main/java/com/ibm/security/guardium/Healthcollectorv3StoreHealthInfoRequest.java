...
import com.ibm.security.guardium.Healthcollectorv3HealthInfoObject;
...
public class Healthcollectorv3StoreHealthInfoRequest {
  ...
  public Healthcollectorv3StoreHealthInfoRequest centralManagerId(@javax.annotation.Nullable String centralManagerId) {
  ...
  public Healthcollectorv3StoreHealthInfoRequest data(@javax.annotation.Nullable List<Healthcollectorv3HealthInfoObject> data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nullable List<Healthcollectorv3HealthInfoObject> data) {
    this.data = data;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Healthcollectorv3StoreHealthInfoRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Healthcollectorv3StoreHealthInfoRequest is not found in the empty JSON string", Healthcollectorv3StoreHealthInfoRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Healthcollectorv3StoreHealthInfoRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Healthcollectorv3StoreHealthInfoRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
