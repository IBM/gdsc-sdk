...
public class Assetsv3CustomProperty {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Assetsv3CustomProperty assetsv3CustomProperty = (Assetsv3CustomProperty) o;
    return Objects.equals(this.dataType, assetsv3CustomProperty.dataType) &&
        Objects.equals(this.key, assetsv3CustomProperty.key) &&
        Objects.equals(this.value, assetsv3CustomProperty.value);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dataType, key, value);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Assetsv3CustomProperty {\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Assetsv3CustomProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Assetsv3CustomProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Assetsv3CustomProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Assetsv3CustomProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<Assetsv3CustomProperty>() {
           @Override
           public void write(JsonWriter out, Assetsv3CustomProperty value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Assetsv3CustomProperty read(JsonReader in) throws IOException {
