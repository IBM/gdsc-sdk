...
public class ListDataStoresSortParameter {
  ...
  public ListDataStoresSortParameter sortBy(@javax.annotation.Nonnull SortByEnum sortBy) {
    this.sortBy = sortBy;
    return this;
  }
  ...
  public ListDataStoresSortParameter sortOrder(@javax.annotation.Nullable SortOrder sortOrder) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListDataStoresSortParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ListDataStoresSortParameter is not found in the empty JSON string", ListDataStoresSortParameter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListDataStoresSortParameter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ListDataStoresSortParameter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
