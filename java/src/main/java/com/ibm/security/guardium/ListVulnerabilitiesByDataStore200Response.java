...
public class ListVulnerabilitiesByDataStore200Response {
  ...
  public ListVulnerabilitiesByDataStore200Response results(@javax.annotation.Nonnull List<VulnerabilityByDataStoreListItem> results) {
  ...
  public void setResults(@javax.annotation.Nonnull List<VulnerabilityByDataStoreListItem> results) {
    this.results = results;
  }


  public ListVulnerabilitiesByDataStore200Response nextToken(@javax.annotation.Nullable String nextToken) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListVulnerabilitiesByDataStore200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ListVulnerabilitiesByDataStore200Response is not found in the empty JSON string", ListVulnerabilitiesByDataStore200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListVulnerabilitiesByDataStore200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ListVulnerabilitiesByDataStore200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
