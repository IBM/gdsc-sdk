...
public class Resourcecontrollerk8v3QueryControllerLogsRequest {
  ...
  public static final String SERIALIZED_NAME_QUERY_LOGS = "query_logs";
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `query_logs`
      if (jsonObj.get("query_logs") != null && !jsonObj.get("query_logs").isJsonNull()) {
        Resourcecontrollerk8v3QueryLogs.validateJsonElement(jsonObj.get("query_logs"));
      }
  }
