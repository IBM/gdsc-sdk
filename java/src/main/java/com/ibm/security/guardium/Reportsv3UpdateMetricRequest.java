...
public class Reportsv3UpdateMetricRequest {
  ...
  public boolean equals(Object o) {
    ...
    Reportsv3UpdateMetricRequest reportsv3UpdateMetricRequest = (Reportsv3UpdateMetricRequest) o;
    return Objects.equals(this.metric, reportsv3UpdateMetricRequest.metric) &&
        Objects.equals(this.metricId, reportsv3UpdateMetricRequest.metricId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(metric, metricId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Reportsv3UpdateMetricRequest {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Reportsv3UpdateMetricRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Reportsv3UpdateMetricRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Reportsv3UpdateMetricRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Reportsv3UpdateMetricRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<Reportsv3UpdateMetricRequest>() {
           @Override
           public void write(JsonWriter out, Reportsv3UpdateMetricRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Reportsv3UpdateMetricRequest read(JsonReader in) throws IOException {
