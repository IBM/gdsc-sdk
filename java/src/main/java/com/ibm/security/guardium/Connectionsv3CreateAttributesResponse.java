...
public class Connectionsv3CreateAttributesResponse {
  ...
  public Connectionsv3CreateAttributesResponse message(@javax.annotation.Nullable String message) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Connectionsv3CreateAttributesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Connectionsv3CreateAttributesResponse is not found in the empty JSON string", Connectionsv3CreateAttributesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Connectionsv3CreateAttributesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Connectionsv3CreateAttributesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
