...
public class Workflowv3ReportResultRow {
  ...
  public Workflowv3ReportResultRow row(@javax.annotation.Nullable Map<String, String> row) {
    this.row = row;
    return this;
  }
  ...
  public void setRow(@javax.annotation.Nullable Map<String, String> row) {
    this.row = row;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("row"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Workflowv3ReportResultRow.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Workflowv3ReportResultRow is not found in the empty JSON string", Workflowv3ReportResultRow.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Workflowv3ReportResultRow.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Workflowv3ReportResultRow` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
