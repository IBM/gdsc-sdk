...
public class Workflowv3CreateCaseResponse {
  ...
  public Workflowv3CreateCaseResponse created(@javax.annotation.Nullable String created) {
  ...
  public Workflowv3CreateCaseResponse status(@javax.annotation.Nullable GooglerpcStatus status) {
    this.status = status;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Workflowv3CreateCaseResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Workflowv3CreateCaseResponse is not found in the empty JSON string", Workflowv3CreateCaseResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Workflowv3CreateCaseResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Workflowv3CreateCaseResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
