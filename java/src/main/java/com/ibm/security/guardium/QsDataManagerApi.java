...
public class QsDataManagerApi {
    ...
    /**
     * Build call for qSDataManagerGetPluginData
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call qSDataManagerGetPluginDataCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/v3/datamanager/plugin";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call qSDataManagerGetPluginDataValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return qSDataManagerGetPluginDataCall(_callback);
     ...
     */
    public Qspmdatamanagerv3PluginDataResponse qSDataManagerGetPluginData() throws ApiException {
        ApiResponse<Qspmdatamanagerv3PluginDataResponse> localVarResp = qSDataManagerGetPluginDataWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Qspmdatamanagerv3PluginDataResponse> qSDataManagerGetPluginDataWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = qSDataManagerGetPluginDataValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<Qspmdatamanagerv3PluginDataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Summary: Plugins Details Description: Retrieves All plugins information. (asynchronously)
     * 
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    public okhttp3.Call qSDataManagerGetPluginDataAsync(final ApiCallback<Qspmdatamanagerv3PluginDataResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = qSDataManagerGetPluginDataValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<Qspmdatamanagerv3PluginDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
