...
public class Policybuilderv3GetPolicyVersionsInfoResponse {
  ...
  **/
  ...
  public Policybuilderv3GetPolicyVersionsInfoResponse addVersionsInfoItem(Policybuilderv3VersionInfo versionsInfoItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Policybuilderv3GetPolicyVersionsInfoResponse policybuilderv3GetPolicyVersionsInfoResponse = (Policybuilderv3GetPolicyVersionsInfoResponse) o;
    return Objects.equals(this.status, policybuilderv3GetPolicyVersionsInfoResponse.status) &&
        Objects.equals(this.versionsInfo, policybuilderv3GetPolicyVersionsInfoResponse.versionsInfo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, versionsInfo);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Policybuilderv3GetPolicyVersionsInfoResponse {\n");
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("versions_info") != null && !jsonObj.get("versions_info").isJsonNull()) {
        JsonArray jsonArrayversionsInfo = jsonObj.getAsJsonArray("versions_info");
        if (jsonArrayversionsInfo != null) {
          ...
          for (int i = 0; i < jsonArrayversionsInfo.size(); i++) {
            Policybuilderv3VersionInfo.validateJsonElement(jsonArrayversionsInfo.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Policybuilderv3GetPolicyVersionsInfoResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Policybuilderv3GetPolicyVersionsInfoResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Policybuilderv3GetPolicyVersionsInfoResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Policybuilderv3GetPolicyVersionsInfoResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<Policybuilderv3GetPolicyVersionsInfoResponse>() {
           @Override
           public void write(JsonWriter out, Policybuilderv3GetPolicyVersionsInfoResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Policybuilderv3GetPolicyVersionsInfoResponse read(JsonReader in) throws IOException {
