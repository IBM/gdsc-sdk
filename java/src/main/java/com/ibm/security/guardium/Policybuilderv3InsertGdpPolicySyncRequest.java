...
public class Policybuilderv3InsertGdpPolicySyncRequest {
  ...
  public Policybuilderv3InsertGdpPolicySyncRequest gdpPolicies(@javax.annotation.Nullable List<Policybuilderv3GDPSyncEntry> gdpPolicies) {
  ...
  public void setGdpPolicies(@javax.annotation.Nullable List<Policybuilderv3GDPSyncEntry> gdpPolicies) {
    this.gdpPolicies = gdpPolicies;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("gdp_policies"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Policybuilderv3InsertGdpPolicySyncRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Policybuilderv3InsertGdpPolicySyncRequest is not found in the empty JSON string", Policybuilderv3InsertGdpPolicySyncRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Policybuilderv3InsertGdpPolicySyncRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Policybuilderv3InsertGdpPolicySyncRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
