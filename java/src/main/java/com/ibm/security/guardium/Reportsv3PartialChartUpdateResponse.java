...
public class Reportsv3PartialChartUpdateResponse {
  ...
  public Reportsv3PartialChartUpdateResponse chartId(@javax.annotation.Nullable String chartId) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Reportsv3PartialChartUpdateResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Reportsv3PartialChartUpdateResponse is not found in the empty JSON string", Reportsv3PartialChartUpdateResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Reportsv3PartialChartUpdateResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Reportsv3PartialChartUpdateResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
