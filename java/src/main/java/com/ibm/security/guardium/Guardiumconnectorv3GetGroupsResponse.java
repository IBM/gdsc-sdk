...
public class Guardiumconnectorv3GetGroupsResponse {
  ...
  public Guardiumconnectorv3GetGroupsResponse groups(@javax.annotation.Nullable List<Guardiumconnectorv3Group> groups) {
    this.groups = groups;
    return this;
  }
  ...
  public Guardiumconnectorv3GetGroupsResponse status(@javax.annotation.Nullable Guardiumconnectorv3StatusResponseBase status) {
    this.status = status;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Guardiumconnectorv3GetGroupsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Guardiumconnectorv3GetGroupsResponse is not found in the empty JSON string", Guardiumconnectorv3GetGroupsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Guardiumconnectorv3GetGroupsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Guardiumconnectorv3GetGroupsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
