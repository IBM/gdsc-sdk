...
public class DataStoresSummaryStoreTypesInner {
  ...
  public DataStoresSummaryStoreTypesInner storeType(@javax.annotation.Nonnull String storeType) {
  ...
  public void setStoreType(@javax.annotation.Nonnull String storeType) {
    this.storeType = storeType;
  }


  public DataStoresSummaryStoreTypesInner count(@javax.annotation.Nonnull BigDecimal count) {
    this.count = count;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("storeType", "count"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("storeType", "count"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DataStoresSummaryStoreTypesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in DataStoresSummaryStoreTypesInner is not found in the empty JSON string", DataStoresSummaryStoreTypesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DataStoresSummaryStoreTypesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DataStoresSummaryStoreTypesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("storeType").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `storeType` to be a primitive type in the JSON string but got `%s`", jsonObj.get("storeType").toString()));
      }
  }
