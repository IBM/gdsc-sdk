...
public class Guardiumconnectorv3InspectionEngineDetails {
  ...
  public boolean equals(Object o) {
    ...
    Guardiumconnectorv3InspectionEngineDetails guardiumconnectorv3InspectionEngineDetails = (Guardiumconnectorv3InspectionEngineDetails) o;
    return Objects.equals(this.ie, guardiumconnectorv3InspectionEngineDetails.ie) &&
        Objects.equals(this.port, guardiumconnectorv3InspectionEngineDetails.port) &&
        Objects.equals(this.protocol, guardiumconnectorv3InspectionEngineDetails.protocol) &&
        Objects.equals(this.stap, guardiumconnectorv3InspectionEngineDetails.stap) &&
        Objects.equals(this.verificationHealth, guardiumconnectorv3InspectionEngineDetails.verificationHealth) &&
        Objects.equals(this.verificationResult, guardiumconnectorv3InspectionEngineDetails.verificationResult) &&
        Objects.equals(this.verificationState, guardiumconnectorv3InspectionEngineDetails.verificationState) &&
        Objects.equals(this.version, guardiumconnectorv3InspectionEngineDetails.version);
  }
  ...
  public String toString() {
    ...
    sb.append("class Guardiumconnectorv3InspectionEngineDetails {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Guardiumconnectorv3InspectionEngineDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Guardiumconnectorv3InspectionEngineDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Guardiumconnectorv3InspectionEngineDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Guardiumconnectorv3InspectionEngineDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<Guardiumconnectorv3InspectionEngineDetails>() {
           @Override
           public void write(JsonWriter out, Guardiumconnectorv3InspectionEngineDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Guardiumconnectorv3InspectionEngineDetails read(JsonReader in) throws IOException {
