...
public class Resourcecontrollerk8v3TenantGUCCreateResponse {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Resourcecontrollerk8v3TenantGUCCreateResponse resourcecontrollerk8v3TenantGUCCreateResponse = (Resourcecontrollerk8v3TenantGUCCreateResponse) o;
    return Objects.equals(this.message, resourcecontrollerk8v3TenantGUCCreateResponse.message) &&
        Objects.equals(this.routeFqdn, resourcecontrollerk8v3TenantGUCCreateResponse.routeFqdn) &&
        Objects.equals(this.status, resourcecontrollerk8v3TenantGUCCreateResponse.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(message, routeFqdn, status);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Resourcecontrollerk8v3TenantGUCCreateResponse {\n");
    sb.append("    message: ").append(toIndentedString(message)).append("\n");
    sb.append("    routeFqdn: ").append(toIndentedString(routeFqdn)).append("\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Resourcecontrollerk8v3TenantGUCCreateResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Resourcecontrollerk8v3TenantGUCCreateResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Resourcecontrollerk8v3TenantGUCCreateResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Resourcecontrollerk8v3TenantGUCCreateResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<Resourcecontrollerk8v3TenantGUCCreateResponse>() {
           @Override
           public void write(JsonWriter out, Resourcecontrollerk8v3TenantGUCCreateResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Resourcecontrollerk8v3TenantGUCCreateResponse read(JsonReader in) throws IOException {
