...
public class Reportsv3UpdateGradeResponse {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Reportsv3UpdateGradeResponse reportsv3UpdateGradeResponse = (Reportsv3UpdateGradeResponse) o;
    return Objects.equals(this.gradeId, reportsv3UpdateGradeResponse.gradeId);
  }
  ...
  public String toString() {
    ...
    sb.append("class Reportsv3UpdateGradeResponse {\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Reportsv3UpdateGradeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Reportsv3UpdateGradeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Reportsv3UpdateGradeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Reportsv3UpdateGradeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<Reportsv3UpdateGradeResponse>() {
           @Override
           public void write(JsonWriter out, Reportsv3UpdateGradeResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Reportsv3UpdateGradeResponse read(JsonReader in) throws IOException {
