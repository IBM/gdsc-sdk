...
public class Assetsv3GetFiltersDataResponse {
  ...
  public Assetsv3GetFiltersDataResponse category(@javax.annotation.Nullable List<Assetsv3Category> category) {
  ...
  public void setCategory(@javax.annotation.Nullable List<Assetsv3Category> category) {
    this.category = category;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Assetsv3GetFiltersDataResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Assetsv3GetFiltersDataResponse is not found in the empty JSON string", Assetsv3GetFiltersDataResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Assetsv3GetFiltersDataResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Assetsv3GetFiltersDataResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
