...
public class ListActualFlows200Response {
  ...
  public ListActualFlows200Response results(@javax.annotation.Nonnull List<ActualFlow> results) {
  ...
  public void setResults(@javax.annotation.Nonnull List<ActualFlow> results) {
    this.results = results;
  }


  public ListActualFlows200Response nextToken(@javax.annotation.Nullable String nextToken) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListActualFlows200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ListActualFlows200Response is not found in the empty JSON string", ListActualFlows200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListActualFlows200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ListActualFlows200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
