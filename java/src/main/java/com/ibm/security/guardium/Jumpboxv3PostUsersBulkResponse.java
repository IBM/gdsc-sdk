...
public class Jumpboxv3PostUsersBulkResponse {
  ...
  public Jumpboxv3PostUsersBulkResponse location(@javax.annotation.Nullable String location) {
  ...
  public Jumpboxv3PostUsersBulkResponse message(@javax.annotation.Nullable String message) {
  ...
  public Jumpboxv3PostUsersBulkResponse userIds(@javax.annotation.Nullable List<String> userIds) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("location", "message", "user_ids"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Jumpboxv3PostUsersBulkResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Jumpboxv3PostUsersBulkResponse is not found in the empty JSON string", Jumpboxv3PostUsersBulkResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Jumpboxv3PostUsersBulkResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Jumpboxv3PostUsersBulkResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
