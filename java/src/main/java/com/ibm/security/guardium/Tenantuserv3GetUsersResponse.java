...
public class Tenantuserv3GetUsersResponse {
  ...
  public Tenantuserv3GetUsersResponse users(@javax.annotation.Nullable List<Tenantuserv3User> users) {
    this.users = users;
    return this;
  }
  ...
  public void setUsers(@javax.annotation.Nullable List<Tenantuserv3User> users) {
    this.users = users;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Tenantuserv3GetUsersResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Tenantuserv3GetUsersResponse is not found in the empty JSON string", Tenantuserv3GetUsersResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Tenantuserv3GetUsersResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Tenantuserv3GetUsersResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
