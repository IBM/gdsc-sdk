...
public class Assetsv3ImportCSVRequest {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Assetsv3ImportCSVRequest assetsv3ImportCSVRequest = (Assetsv3ImportCSVRequest) o;
    return Objects.equals(this.csvId, assetsv3ImportCSVRequest.csvId) &&
        Objects.equals(this.importAction, assetsv3ImportCSVRequest.importAction) &&
        Objects.equals(this.templateType, assetsv3ImportCSVRequest.templateType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(csvId, importAction, templateType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Assetsv3ImportCSVRequest {\n");
    sb.append("    csvId: ").append(toIndentedString(csvId)).append("\n");
    sb.append("    importAction: ").append(toIndentedString(importAction)).append("\n");
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("template_type") != null && !jsonObj.get("template_type").isJsonNull()) {
        Assetsv3TemplateType.validateJsonElement(jsonObj.get("template_type"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Assetsv3ImportCSVRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Assetsv3ImportCSVRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Assetsv3ImportCSVRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Assetsv3ImportCSVRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<Assetsv3ImportCSVRequest>() {
           @Override
           public void write(JsonWriter out, Assetsv3ImportCSVRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Assetsv3ImportCSVRequest read(JsonReader in) throws IOException {
