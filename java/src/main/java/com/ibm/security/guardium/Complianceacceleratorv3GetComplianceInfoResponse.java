...
public class Complianceacceleratorv3GetComplianceInfoResponse {
  ...
  public Complianceacceleratorv3GetComplianceInfoResponse complianceInfo(@javax.annotation.Nullable Complianceacceleratorv3ComplianceInfo complianceInfo) {
  ...
  public Complianceacceleratorv3GetComplianceInfoResponse status(@javax.annotation.Nullable Complianceacceleratorv3StatusResponseBase status) {
    this.status = status;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("compliance_info", "status"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Complianceacceleratorv3GetComplianceInfoResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Complianceacceleratorv3GetComplianceInfoResponse is not found in the empty JSON string", Complianceacceleratorv3GetComplianceInfoResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Complianceacceleratorv3GetComplianceInfoResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Complianceacceleratorv3GetComplianceInfoResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
