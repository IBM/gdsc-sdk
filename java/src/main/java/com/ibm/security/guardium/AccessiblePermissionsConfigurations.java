...
public class AccessiblePermissionsConfigurations {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AccessiblePermissionsConfigurations accessiblePermissionsConfigurations = (AccessiblePermissionsConfigurations) o;
    return Objects.equals(this.accessiblePermissionConfigurations, accessiblePermissionsConfigurations.accessiblePermissionConfigurations);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessiblePermissionConfigurations);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AccessiblePermissionsConfigurations {\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccessiblePermissionsConfigurations.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccessiblePermissionsConfigurations' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccessiblePermissionsConfigurations> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccessiblePermissionsConfigurations.class));

       return (TypeAdapter<T>) new TypeAdapter<AccessiblePermissionsConfigurations>() {
           @Override
           public void write(JsonWriter out, AccessiblePermissionsConfigurations value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccessiblePermissionsConfigurations read(JsonReader in) throws IOException {
