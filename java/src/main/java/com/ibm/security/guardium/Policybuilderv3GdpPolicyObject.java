...
public class Policybuilderv3GdpPolicyObject {
  ...
  public Policybuilderv3GdpPolicyObject id(@javax.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public Policybuilderv3GdpPolicyObject policyDescription(@javax.annotation.Nullable String policyDescription) {
  ...
  public Policybuilderv3GdpPolicyObject policyRulesCount(@javax.annotation.Nullable String policyRulesCount) {
  ...
  public void setPolicyRulesCount(@javax.annotation.Nullable String policyRulesCount) {
    this.policyRulesCount = policyRulesCount;
  }


  public Policybuilderv3GdpPolicyObject policySubType(@javax.annotation.Nullable String policySubType) {
  ...
  public Policybuilderv3GdpPolicyObject policyType(@javax.annotation.Nullable String policyType) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Policybuilderv3GdpPolicyObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Policybuilderv3GdpPolicyObject is not found in the empty JSON string", Policybuilderv3GdpPolicyObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Policybuilderv3GdpPolicyObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Policybuilderv3GdpPolicyObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("policy_rules_count") != null && !jsonObj.get("policy_rules_count").isJsonNull()) && !jsonObj.get("policy_rules_count").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `policy_rules_count` to be a primitive type in the JSON string but got `%s`", jsonObj.get("policy_rules_count").toString()));
      }
