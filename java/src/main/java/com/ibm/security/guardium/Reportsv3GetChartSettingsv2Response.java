...
public class Reportsv3GetChartSettingsv2Response {
  ...
  public Reportsv3GetChartSettingsv2Response chartSettings(@javax.annotation.Nullable List<Reportsv3ChartSettingsv2> chartSettings) {
  ...
  public void setChartSettings(@javax.annotation.Nullable List<Reportsv3ChartSettingsv2> chartSettings) {
    this.chartSettings = chartSettings;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Reportsv3GetChartSettingsv2Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Reportsv3GetChartSettingsv2Response is not found in the empty JSON string", Reportsv3GetChartSettingsv2Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Reportsv3GetChartSettingsv2Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Reportsv3GetChartSettingsv2Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
