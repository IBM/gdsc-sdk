...
public class Riskanalyticscontrollerv3EnableDisableRiskEventFeedbackRequest {
  ...
  public Riskanalyticscontrollerv3EnableDisableRiskEventFeedbackRequest action(@javax.annotation.Nullable Riskanalyticscontrollerv3Action action) {
    this.action = action;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Riskanalyticscontrollerv3EnableDisableRiskEventFeedbackRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Riskanalyticscontrollerv3EnableDisableRiskEventFeedbackRequest is not found in the empty JSON string", Riskanalyticscontrollerv3EnableDisableRiskEventFeedbackRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Riskanalyticscontrollerv3EnableDisableRiskEventFeedbackRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Riskanalyticscontrollerv3EnableDisableRiskEventFeedbackRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
