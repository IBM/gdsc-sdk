...
import com.ibm.security.guardium.Schedulerv3ScheduledJob;
...
public class Schedulerv3GetScheduledJobResponse {
  ...
  public Schedulerv3GetScheduledJobResponse scheduledJob(@javax.annotation.Nullable Schedulerv3ScheduledJob scheduledJob) {
  ...
  public void setScheduledJob(@javax.annotation.Nullable Schedulerv3ScheduledJob scheduledJob) {
    this.scheduledJob = scheduledJob;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("scheduled_job"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Schedulerv3GetScheduledJobResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Schedulerv3GetScheduledJobResponse is not found in the empty JSON string", Schedulerv3GetScheduledJobResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Schedulerv3GetScheduledJobResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Schedulerv3GetScheduledJobResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
