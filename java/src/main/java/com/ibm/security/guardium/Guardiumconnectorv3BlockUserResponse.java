...
public class Guardiumconnectorv3BlockUserResponse {
  ...
  public Guardiumconnectorv3BlockUserResponse blockResult(@javax.annotation.Nullable Boolean blockResult) {
  ...
  public void setBlockResult(@javax.annotation.Nullable Boolean blockResult) {
    this.blockResult = blockResult;
  }


  public Guardiumconnectorv3BlockUserResponse err(@javax.annotation.Nullable String err) {
    this.err = err;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("block_result", "err"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Guardiumconnectorv3BlockUserResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Guardiumconnectorv3BlockUserResponse is not found in the empty JSON string", Guardiumconnectorv3BlockUserResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Guardiumconnectorv3BlockUserResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Guardiumconnectorv3BlockUserResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
