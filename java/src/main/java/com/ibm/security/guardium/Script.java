...
public class Script {
  ...
  public Script script(@javax.annotation.Nullable String script) {
    this.script = script;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.script, script.script);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("script"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Script.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Script is not found in the empty JSON string", Script.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Script.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Script` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
