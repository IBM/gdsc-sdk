...
public class Workflowv3TaskListResponse {
  ...
  public Workflowv3TaskListResponse status(@javax.annotation.Nullable GooglerpcStatus status) {
    this.status = status;
    return this;
  }
  ...
  public Workflowv3TaskListResponse tasks(@javax.annotation.Nullable List<Workflowv3Task> tasks) {
    this.tasks = tasks;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Workflowv3TaskListResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Workflowv3TaskListResponse is not found in the empty JSON string", Workflowv3TaskListResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Workflowv3TaskListResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Workflowv3TaskListResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
