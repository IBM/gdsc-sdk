...
public class AnalyzedRegion {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AnalyzedRegion analyzedRegion = (AnalyzedRegion) o;
    return Objects.equals(this.name, analyzedRegion.name) &&
        Objects.equals(this.isAnalyzed, analyzedRegion.isAnalyzed);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, isAnalyzed);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AnalyzedRegion {\n");
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    isAnalyzed: ").append(toIndentedString(isAnalyzed)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AnalyzedRegion.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AnalyzedRegion' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AnalyzedRegion> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AnalyzedRegion.class));

       return (TypeAdapter<T>) new TypeAdapter<AnalyzedRegion>() {
           @Override
           public void write(JsonWriter out, AnalyzedRegion value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AnalyzedRegion read(JsonReader in) throws IOException {
