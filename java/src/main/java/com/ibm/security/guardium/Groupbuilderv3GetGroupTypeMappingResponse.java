...
public class Groupbuilderv3GetGroupTypeMappingResponse {
  ...
  public Groupbuilderv3GetGroupTypeMappingResponse status(@javax.annotation.Nullable Groupbuilderv3StatusResponseBase status) {
    this.status = status;
    return this;
  }
  ...
  public Groupbuilderv3GetGroupTypeMappingResponse typeMap(@javax.annotation.Nullable Map<String, Integer> typeMap) {
  ...
  public void setTypeMap(@javax.annotation.Nullable Map<String, Integer> typeMap) {
    this.typeMap = typeMap;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("status", "type_map"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Groupbuilderv3GetGroupTypeMappingResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Groupbuilderv3GetGroupTypeMappingResponse is not found in the empty JSON string", Groupbuilderv3GetGroupTypeMappingResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Groupbuilderv3GetGroupTypeMappingResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Groupbuilderv3GetGroupTypeMappingResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
