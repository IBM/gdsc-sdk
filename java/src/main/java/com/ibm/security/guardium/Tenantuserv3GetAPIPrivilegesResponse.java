...
public class Tenantuserv3GetAPIPrivilegesResponse {
  ...
  public Tenantuserv3GetAPIPrivilegesResponse putPrivilegesItem(String key, Boolean privilegesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Tenantuserv3GetAPIPrivilegesResponse tenantuserv3GetAPIPrivilegesResponse = (Tenantuserv3GetAPIPrivilegesResponse) o;
    return Objects.equals(this.privileges, tenantuserv3GetAPIPrivilegesResponse.privileges);
  }
  ...
  public String toString() {
    ...
    sb.append("class Tenantuserv3GetAPIPrivilegesResponse {\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Tenantuserv3GetAPIPrivilegesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Tenantuserv3GetAPIPrivilegesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Tenantuserv3GetAPIPrivilegesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Tenantuserv3GetAPIPrivilegesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<Tenantuserv3GetAPIPrivilegesResponse>() {
           @Override
           public void write(JsonWriter out, Tenantuserv3GetAPIPrivilegesResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Tenantuserv3GetAPIPrivilegesResponse read(JsonReader in) throws IOException {
