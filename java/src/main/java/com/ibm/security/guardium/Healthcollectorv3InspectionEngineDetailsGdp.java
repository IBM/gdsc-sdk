...
public class Healthcollectorv3InspectionEngineDetailsGdp {
  ...
  public Healthcollectorv3InspectionEngineDetailsGdp ie(@javax.annotation.Nullable String ie) {
    this.ie = ie;
    return this;
  }
  ...
  public Healthcollectorv3InspectionEngineDetailsGdp port(@javax.annotation.Nullable String port) {
    this.port = port;
    return this;
  }
  ...
  public Healthcollectorv3InspectionEngineDetailsGdp protocol(@javax.annotation.Nullable String protocol) {
  ...
  public Healthcollectorv3InspectionEngineDetailsGdp stap(@javax.annotation.Nullable String stap) {
    this.stap = stap;
    return this;
  }
  ...
  public Healthcollectorv3InspectionEngineDetailsGdp verificationHealth(@javax.annotation.Nullable Integer verificationHealth) {
  ...
  public Healthcollectorv3InspectionEngineDetailsGdp verificationResult(@javax.annotation.Nullable String verificationResult) {
  ...
  public Healthcollectorv3InspectionEngineDetailsGdp verificationState(@javax.annotation.Nullable String verificationState) {
  ...
  public Healthcollectorv3InspectionEngineDetailsGdp version(@javax.annotation.Nullable String version) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Healthcollectorv3InspectionEngineDetailsGdp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Healthcollectorv3InspectionEngineDetailsGdp is not found in the empty JSON string", Healthcollectorv3InspectionEngineDetailsGdp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Healthcollectorv3InspectionEngineDetailsGdp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Healthcollectorv3InspectionEngineDetailsGdp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
