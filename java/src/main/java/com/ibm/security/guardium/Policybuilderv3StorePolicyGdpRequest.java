...
public class Policybuilderv3StorePolicyGdpRequest {
  ...
  public Policybuilderv3StorePolicyGdpRequest centralManagerId(@javax.annotation.Nullable String centralManagerId) {
  ...
  public Policybuilderv3StorePolicyGdpRequest data(@javax.annotation.Nullable String data) {
    this.data = data;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Policybuilderv3StorePolicyGdpRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Policybuilderv3StorePolicyGdpRequest is not found in the empty JSON string", Policybuilderv3StorePolicyGdpRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Policybuilderv3StorePolicyGdpRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Policybuilderv3StorePolicyGdpRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
