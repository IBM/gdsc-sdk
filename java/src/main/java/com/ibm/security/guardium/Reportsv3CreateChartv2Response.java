...
public class Reportsv3CreateChartv2Response {
  ...
  public Reportsv3CreateChartv2Response chartId(@javax.annotation.Nullable String chartId) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Reportsv3CreateChartv2Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Reportsv3CreateChartv2Response is not found in the empty JSON string", Reportsv3CreateChartv2Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Reportsv3CreateChartv2Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Reportsv3CreateChartv2Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
