...
public class Reportsv3RunVariantOperationResponse {
  ...
  public Reportsv3RunVariantOperationResponse message(@javax.annotation.Nullable String message) {
  ...
  public Reportsv3RunVariantOperationResponse output(@javax.annotation.Nullable List<String> output) {
    this.output = output;
    return this;
  }
  ...
  public void setOutput(@javax.annotation.Nullable List<String> output) {
    this.output = output;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("message", "output"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Reportsv3RunVariantOperationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Reportsv3RunVariantOperationResponse is not found in the empty JSON string", Reportsv3RunVariantOperationResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Reportsv3RunVariantOperationResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Reportsv3RunVariantOperationResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("output") != null && !jsonObj.get("output").isJsonNull() && !jsonObj.get("output").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `output` to be an array in the JSON string but got `%s`", jsonObj.get("output").toString()));
      }
  }
