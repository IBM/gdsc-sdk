...
public class Connectionsv3CreateConnectionsConfigsResponse {
  ...
  public Connectionsv3CreateConnectionsConfigsResponse message(@javax.annotation.Nullable String message) {
  ...
  public Connectionsv3CreateConnectionsConfigsResponse status(@javax.annotation.Nullable Integer status) {
    this.status = status;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Connectionsv3CreateConnectionsConfigsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Connectionsv3CreateConnectionsConfigsResponse is not found in the empty JSON string", Connectionsv3CreateConnectionsConfigsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Connectionsv3CreateConnectionsConfigsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Connectionsv3CreateConnectionsConfigsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
