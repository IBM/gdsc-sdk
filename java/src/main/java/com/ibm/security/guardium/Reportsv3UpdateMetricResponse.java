...
public class Reportsv3UpdateMetricResponse {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Reportsv3UpdateMetricResponse reportsv3UpdateMetricResponse = (Reportsv3UpdateMetricResponse) o;
    return Objects.equals(this.metricId, reportsv3UpdateMetricResponse.metricId);
  }
  ...
  public String toString() {
    ...
    sb.append("class Reportsv3UpdateMetricResponse {\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Reportsv3UpdateMetricResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Reportsv3UpdateMetricResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Reportsv3UpdateMetricResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Reportsv3UpdateMetricResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<Reportsv3UpdateMetricResponse>() {
           @Override
           public void write(JsonWriter out, Reportsv3UpdateMetricResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Reportsv3UpdateMetricResponse read(JsonReader in) throws IOException {
