...
public class Reportsv3CreateJoinRequest {
  ...
  public Reportsv3CreateJoinRequest joinDefinition(@javax.annotation.Nullable Reportsv3JoinDefinition joinDefinition) {
  ...
  public void setJoinDefinition(@javax.annotation.Nullable Reportsv3JoinDefinition joinDefinition) {
    this.joinDefinition = joinDefinition;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("join_definition"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Reportsv3CreateJoinRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Reportsv3CreateJoinRequest is not found in the empty JSON string", Reportsv3CreateJoinRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Reportsv3CreateJoinRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Reportsv3CreateJoinRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
