...
public class Reportsv3DeleteRequirementRequest {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Reportsv3DeleteRequirementRequest reportsv3DeleteRequirementRequest = (Reportsv3DeleteRequirementRequest) o;
    return Objects.equals(this.requirementId, reportsv3DeleteRequirementRequest.requirementId);
  }
  ...
  public String toString() {
    ...
    sb.append("class Reportsv3DeleteRequirementRequest {\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Reportsv3DeleteRequirementRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Reportsv3DeleteRequirementRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Reportsv3DeleteRequirementRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Reportsv3DeleteRequirementRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<Reportsv3DeleteRequirementRequest>() {
           @Override
           public void write(JsonWriter out, Reportsv3DeleteRequirementRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Reportsv3DeleteRequirementRequest read(JsonReader in) throws IOException {
