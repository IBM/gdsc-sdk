...
import com.ibm.security.auth.Authentication;
import com.ibm.security.auth.HttpBasicAuth;
import com.ibm.security.auth.HttpBearerAuth;
import com.ibm.security.auth.ApiKeyAuth;
...
public class ApiClient {
     ...
     * @return a {@link com.ibm.security.ApiClient} object
     */
    ...
    */
     ...
     * @throws com.ibm.security.ApiException If fail to deserialize response body, i.e. cannot read response body
    ...
    public <T> T deserialize(Response response, Type returnType) throws ApiException {
        ...
        try {
            if (isJsonMime(contentType)) {
                String respBodyString = new String(respBody.byteStream().readAllBytes(), java.nio.charset.StandardCharsets.UTF_8);
                respBodyString = respBodyString.replaceAll("\\}\\}\\n\\{\"result\":\\{", ",");
                return JSON.deserialize(new java.io.ByteArrayInputStream(respBodyString.getBytes(java.nio.charset.StandardCharsets.UTF_8)), returnType);            } else if (returnType.equals(String.class)) {
     ...
     * @throws com.ibm.security.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.ibm.security.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.ibm.security.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.ibm.security.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.ibm.security.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.ibm.security.ApiException If fails to update the parameters
     */
     ...
     * @throws com.ibm.security.ApiException If fail to serialize the request body object into a string
     */
